...
public final class PersonType_propertySet extends BaseGeneratedEMFQuerySpecification<PersonType_propertySet.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.PersonType_propertySet pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.PersonType_propertySet";
    }
    
    @Override
    public List<String> parameterNames() {
      return PersonType_propertySet.Match.parameterNames;
    }
    ...
    @Override
    public PersonType_propertySet.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof PersonType_propertySet.Match)) {
          PersonType_propertySet.Match other = (PersonType_propertySet.Match) obj;
    ...
    @Override
    public PersonType_propertySet specification() {
      return PersonType_propertySet.instance();
    }
     ...
     * 
     */
    public static PersonType_propertySet.Match newEmptyMatch() {
     ...
     * 
     */
    public static PersonType_propertySet.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static PersonType_propertySet.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends PersonType_propertySet.Match {
    ...
    private static final class Immutable extends PersonType_propertySet.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.PersonType_propertySet pattern,
   ...
   * 
   * @see Match
   * @see PersonType_propertySet
   * 
   */
  public static class Matcher extends BaseMatcher<PersonType_propertySet.Match> {
    /**
     ...
     * 
     */
    public static PersonType_propertySet.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static PersonType_propertySet.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(PersonType_propertySet.Matcher.class);
     ...
     * 
     */
    public Collection<PersonType_propertySet.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<PersonType_propertySet.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<PersonType_propertySet.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super PersonType_propertySet.Match> processor) {
     ...
     * 
     */
    public PersonType_propertySet.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return PersonType_propertySet.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final PersonType_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final PersonType_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final PersonType_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final PersonType_propertySet.Match partialMatch) {
    ...
    @Override
    protected PersonType_propertySet.Match tupleToMatch(final Tuple t) {
      try {
          return PersonType_propertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected PersonType_propertySet.Match arrayToMatch(final Object[] match) {
      try {
          return PersonType_propertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected PersonType_propertySet.Match arrayToMatchMutable(final Object[] match) {
      try {
          return PersonType_propertySet.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<PersonType_propertySet.Matcher> querySpecification() {
      return PersonType_propertySet.instance();
    }
  }
  
  private PersonType_propertySet() {
   ...
   * 
   */
  public static PersonType_propertySet instance() {
    try{
  ...
  @Override
  protected PersonType_propertySet.Matcher instantiate(final ViatraQueryEngine engine) {
    return PersonType_propertySet.Matcher.on(engine);
  }
  
  @Override
  public PersonType_propertySet.Matcher instantiate() {
    return PersonType_propertySet.Matcher.create();
  }
  
  @Override
  public PersonType_propertySet.Match newEmptyMatch() {
    return PersonType_propertySet.Match.newEmptyMatch();
  }
  
  @Override
  public PersonType_propertySet.Match newMatch(final Object... parameters) {
    return PersonType_propertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link PersonType_propertySet} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link PersonType_propertySet#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final PersonType_propertySet INSTANCE = new PersonType_propertySet();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final PersonType_propertySet.GeneratedPQuery INSTANCE = new GeneratedPQuery();
