...
public final class ExternalTupleType_URI extends BaseGeneratedEMFQuerySpecification<ExternalTupleType_URI.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ExternalTupleType_URI pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.ExternalTupleType_URI";
    }
    
    @Override
    public List<String> parameterNames() {
      return ExternalTupleType_URI.Match.parameterNames;
    }
    ...
    @Override
    public ExternalTupleType_URI.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ExternalTupleType_URI.Match)) {
          ExternalTupleType_URI.Match other = (ExternalTupleType_URI.Match) obj;
    ...
    @Override
    public ExternalTupleType_URI specification() {
      return ExternalTupleType_URI.instance();
    }
     ...
     * 
     */
    public static ExternalTupleType_URI.Match newEmptyMatch() {
     ...
     * 
     */
    public static ExternalTupleType_URI.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public static ExternalTupleType_URI.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends ExternalTupleType_URI.Match {
    ...
    private static final class Immutable extends ExternalTupleType_URI.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ExternalTupleType_URI pattern,
   ...
   * 
   * @see Match
   * @see ExternalTupleType_URI
   * 
   */
  public static class Matcher extends BaseMatcher<ExternalTupleType_URI.Match> {
    /**
     ...
     * 
     */
    public static ExternalTupleType_URI.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ExternalTupleType_URI.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ExternalTupleType_URI.Matcher.class);
     ...
     * 
     */
    public Collection<ExternalTupleType_URI.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Stream<ExternalTupleType_URI.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Optional<ExternalTupleType_URI.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec, final Consumer<? super ExternalTupleType_URI.Match> processor) {
     ...
     * 
     */
    public ExternalTupleType_URI.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return ExternalTupleType_URI.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final ExternalTupleType_URI.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final ExternalTupleType_URI.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralString> streamAllValuesOfvaluespec(final ExternalTupleType_URI.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralString> getAllValuesOfvaluespec(final ExternalTupleType_URI.Match partialMatch) {
    ...
    @Override
    protected ExternalTupleType_URI.Match tupleToMatch(final Tuple t) {
      try {
          return ExternalTupleType_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (LiteralString) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected ExternalTupleType_URI.Match arrayToMatch(final Object[] match) {
      try {
          return ExternalTupleType_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ExternalTupleType_URI.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ExternalTupleType_URI.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ExternalTupleType_URI.Matcher> querySpecification() {
      return ExternalTupleType_URI.instance();
    }
  }
  
  private ExternalTupleType_URI() {
   ...
   * 
   */
  public static ExternalTupleType_URI instance() {
    try{
  ...
  @Override
  protected ExternalTupleType_URI.Matcher instantiate(final ViatraQueryEngine engine) {
    return ExternalTupleType_URI.Matcher.on(engine);
  }
  
  @Override
  public ExternalTupleType_URI.Matcher instantiate() {
    return ExternalTupleType_URI.Matcher.create();
  }
  
  @Override
  public ExternalTupleType_URI.Match newEmptyMatch() {
    return ExternalTupleType_URI.Match.newEmptyMatch();
  }
  
  @Override
  public ExternalTupleType_URI.Match newMatch(final Object... parameters) {
    return ExternalTupleType_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralString) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ExternalTupleType_URI} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ExternalTupleType_URI#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ExternalTupleType_URI INSTANCE = new ExternalTupleType_URI();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ExternalTupleType_URI.GeneratedPQuery INSTANCE = new GeneratedPQuery();
