...
public final class Responsibility_isEncapsulated extends BaseGeneratedEMFQuerySpecification<Responsibility_isEncapsulated.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.Responsibility_isEncapsulated pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.Responsibility_isEncapsulated";
    }
    
    @Override
    public List<String> parameterNames() {
      return Responsibility_isEncapsulated.Match.parameterNames;
    }
    ...
    @Override
    public Responsibility_isEncapsulated.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Responsibility_isEncapsulated.Match)) {
          Responsibility_isEncapsulated.Match other = (Responsibility_isEncapsulated.Match) obj;
    ...
    @Override
    public Responsibility_isEncapsulated specification() {
      return Responsibility_isEncapsulated.instance();
    }
     ...
     * 
     */
    public static Responsibility_isEncapsulated.Match newEmptyMatch() {
     ...
     * 
     */
    public static Responsibility_isEncapsulated.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public static Responsibility_isEncapsulated.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends Responsibility_isEncapsulated.Match {
    ...
    private static final class Immutable extends Responsibility_isEncapsulated.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.Responsibility_isEncapsulated pattern,
   ...
   * 
   * @see Match
   * @see Responsibility_isEncapsulated
   * 
   */
  public static class Matcher extends BaseMatcher<Responsibility_isEncapsulated.Match> {
    /**
     ...
     * 
     */
    public static Responsibility_isEncapsulated.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Responsibility_isEncapsulated.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Responsibility_isEncapsulated.Matcher.class);
     ...
     * 
     */
    public Collection<Responsibility_isEncapsulated.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public Stream<Responsibility_isEncapsulated.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public Optional<Responsibility_isEncapsulated.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec, final Consumer<? super Responsibility_isEncapsulated.Match> processor) {
     ...
     * 
     */
    public Responsibility_isEncapsulated.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
      return Responsibility_isEncapsulated.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Responsibility_isEncapsulated.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Responsibility_isEncapsulated.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralBoolean> streamAllValuesOfvaluespec(final Responsibility_isEncapsulated.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralBoolean> getAllValuesOfvaluespec(final Responsibility_isEncapsulated.Match partialMatch) {
    ...
    @Override
    protected Responsibility_isEncapsulated.Match tupleToMatch(final Tuple t) {
      try {
          return Responsibility_isEncapsulated.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (LiteralBoolean) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected Responsibility_isEncapsulated.Match arrayToMatch(final Object[] match) {
      try {
          return Responsibility_isEncapsulated.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralBoolean) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Responsibility_isEncapsulated.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Responsibility_isEncapsulated.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralBoolean) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Responsibility_isEncapsulated.Matcher> querySpecification() {
      return Responsibility_isEncapsulated.instance();
    }
  }
  
  private Responsibility_isEncapsulated() {
   ...
   * 
   */
  public static Responsibility_isEncapsulated instance() {
    try{
  ...
  @Override
  protected Responsibility_isEncapsulated.Matcher instantiate(final ViatraQueryEngine engine) {
    return Responsibility_isEncapsulated.Matcher.on(engine);
  }
  
  @Override
  public Responsibility_isEncapsulated.Matcher instantiate() {
    return Responsibility_isEncapsulated.Matcher.create();
  }
  
  @Override
  public Responsibility_isEncapsulated.Match newEmptyMatch() {
    return Responsibility_isEncapsulated.Match.newEmptyMatch();
  }
  
  @Override
  public Responsibility_isEncapsulated.Match newMatch(final Object... parameters) {
    return Responsibility_isEncapsulated.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralBoolean) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Responsibility_isEncapsulated} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Responsibility_isEncapsulated#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Responsibility_isEncapsulated INSTANCE = new Responsibility_isEncapsulated();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Responsibility_isEncapsulated.GeneratedPQuery INSTANCE = new GeneratedPQuery();
