...
public final class OrganizationInEnterprise_sourceContext extends BaseGeneratedEMFQuerySpecification<OrganizationInEnterprise_sourceContext.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.OrganizationInEnterprise_sourceContext pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.OrganizationInEnterprise_sourceContext";
    }
    
    @Override
    public List<String> parameterNames() {
      return OrganizationInEnterprise_sourceContext.Match.parameterNames;
    }
    ...
    @Override
    public OrganizationInEnterprise_sourceContext.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof OrganizationInEnterprise_sourceContext.Match)) {
          OrganizationInEnterprise_sourceContext.Match other = (OrganizationInEnterprise_sourceContext.Match) obj;
    ...
    @Override
    public OrganizationInEnterprise_sourceContext specification() {
      return OrganizationInEnterprise_sourceContext.instance();
    }
     ...
     * 
     */
    public static OrganizationInEnterprise_sourceContext.Match newEmptyMatch() {
     ...
     * 
     */
    public static OrganizationInEnterprise_sourceContext.Match newMutableMatch(final Abstraction pElement, final Classifier pValue) {
     ...
     * 
     */
    public static OrganizationInEnterprise_sourceContext.Match newMatch(final Abstraction pElement, final Classifier pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends OrganizationInEnterprise_sourceContext.Match {
    ...
    private static final class Immutable extends OrganizationInEnterprise_sourceContext.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.OrganizationInEnterprise_sourceContext pattern,
   ...
   * 
   * @see Match
   * @see OrganizationInEnterprise_sourceContext
   * 
   */
  public static class Matcher extends BaseMatcher<OrganizationInEnterprise_sourceContext.Match> {
    /**
     ...
     * 
     */
    public static OrganizationInEnterprise_sourceContext.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static OrganizationInEnterprise_sourceContext.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(OrganizationInEnterprise_sourceContext.Matcher.class);
     ...
     * 
     */
    public Collection<OrganizationInEnterprise_sourceContext.Match> getAllMatches(final Abstraction pElement, final Classifier pValue) {
     ...
     * 
     */
    public Stream<OrganizationInEnterprise_sourceContext.Match> streamAllMatches(final Abstraction pElement, final Classifier pValue) {
     ...
     * 
     */
    public Optional<OrganizationInEnterprise_sourceContext.Match> getOneArbitraryMatch(final Abstraction pElement, final Classifier pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Abstraction pElement, final Classifier pValue, final Consumer<? super OrganizationInEnterprise_sourceContext.Match> processor) {
     ...
     * 
     */
    public OrganizationInEnterprise_sourceContext.Match newMatch(final Abstraction pElement, final Classifier pValue) {
      return OrganizationInEnterprise_sourceContext.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Abstraction> streamAllValuesOfelement(final OrganizationInEnterprise_sourceContext.Match partialMatch) {
     ...
     * 
     */
    public Set<Abstraction> getAllValuesOfelement(final OrganizationInEnterprise_sourceContext.Match partialMatch) {
     ...
     * 
     */
    public Stream<Classifier> streamAllValuesOfvalue(final OrganizationInEnterprise_sourceContext.Match partialMatch) {
     ...
     * 
     */
    public Set<Classifier> getAllValuesOfvalue(final OrganizationInEnterprise_sourceContext.Match partialMatch) {
    ...
    @Override
    protected OrganizationInEnterprise_sourceContext.Match tupleToMatch(final Tuple t) {
      try {
          return OrganizationInEnterprise_sourceContext.Match.newMatch((Abstraction) t.get(POSITION_ELEMENT), (Classifier) t.get(POSITION_VALUE));
    ...
    @Override
    protected OrganizationInEnterprise_sourceContext.Match arrayToMatch(final Object[] match) {
      try {
          return OrganizationInEnterprise_sourceContext.Match.newMatch((Abstraction) match[POSITION_ELEMENT], (Classifier) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected OrganizationInEnterprise_sourceContext.Match arrayToMatchMutable(final Object[] match) {
      try {
          return OrganizationInEnterprise_sourceContext.Match.newMutableMatch((Abstraction) match[POSITION_ELEMENT], (Classifier) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<OrganizationInEnterprise_sourceContext.Matcher> querySpecification() {
      return OrganizationInEnterprise_sourceContext.instance();
    }
  }
  
  private OrganizationInEnterprise_sourceContext() {
   ...
   * 
   */
  public static OrganizationInEnterprise_sourceContext instance() {
    try{
  ...
  @Override
  protected OrganizationInEnterprise_sourceContext.Matcher instantiate(final ViatraQueryEngine engine) {
    return OrganizationInEnterprise_sourceContext.Matcher.on(engine);
  }
  
  @Override
  public OrganizationInEnterprise_sourceContext.Matcher instantiate() {
    return OrganizationInEnterprise_sourceContext.Matcher.create();
  }
  
  @Override
  public OrganizationInEnterprise_sourceContext.Match newEmptyMatch() {
    return OrganizationInEnterprise_sourceContext.Match.newEmptyMatch();
  }
  
  @Override
  public OrganizationInEnterprise_sourceContext.Match newMatch(final Object... parameters) {
    return OrganizationInEnterprise_sourceContext.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mddependencies.Abstraction) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Classifier) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link OrganizationInEnterprise_sourceContext} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link OrganizationInEnterprise_sourceContext#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final OrganizationInEnterprise_sourceContext INSTANCE = new OrganizationInEnterprise_sourceContext();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final OrganizationInEnterprise_sourceContext.GeneratedPQuery INSTANCE = new GeneratedPQuery();
