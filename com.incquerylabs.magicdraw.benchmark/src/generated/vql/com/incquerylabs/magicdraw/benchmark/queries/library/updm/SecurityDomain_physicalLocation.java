...
public final class SecurityDomain_physicalLocation extends BaseGeneratedEMFQuerySpecification<SecurityDomain_physicalLocation.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.SecurityDomain_physicalLocation pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.SecurityDomain_physicalLocation";
    }
    
    @Override
    public List<String> parameterNames() {
      return SecurityDomain_physicalLocation.Match.parameterNames;
    }
    ...
    @Override
    public SecurityDomain_physicalLocation.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof SecurityDomain_physicalLocation.Match)) {
          SecurityDomain_physicalLocation.Match other = (SecurityDomain_physicalLocation.Match) obj;
    ...
    @Override
    public SecurityDomain_physicalLocation specification() {
      return SecurityDomain_physicalLocation.instance();
    }
     ...
     * 
     */
    public static SecurityDomain_physicalLocation.Match newEmptyMatch() {
     ...
     * 
     */
    public static SecurityDomain_physicalLocation.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static SecurityDomain_physicalLocation.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends SecurityDomain_physicalLocation.Match {
    ...
    private static final class Immutable extends SecurityDomain_physicalLocation.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.SecurityDomain_physicalLocation pattern,
   ...
   * 
   * @see Match
   * @see SecurityDomain_physicalLocation
   * 
   */
  public static class Matcher extends BaseMatcher<SecurityDomain_physicalLocation.Match> {
    /**
     ...
     * 
     */
    public static SecurityDomain_physicalLocation.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static SecurityDomain_physicalLocation.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(SecurityDomain_physicalLocation.Matcher.class);
     ...
     * 
     */
    public Collection<SecurityDomain_physicalLocation.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<SecurityDomain_physicalLocation.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<SecurityDomain_physicalLocation.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super SecurityDomain_physicalLocation.Match> processor) {
     ...
     * 
     */
    public SecurityDomain_physicalLocation.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return SecurityDomain_physicalLocation.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final SecurityDomain_physicalLocation.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final SecurityDomain_physicalLocation.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final SecurityDomain_physicalLocation.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final SecurityDomain_physicalLocation.Match partialMatch) {
    ...
    @Override
    protected SecurityDomain_physicalLocation.Match tupleToMatch(final Tuple t) {
      try {
          return SecurityDomain_physicalLocation.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected SecurityDomain_physicalLocation.Match arrayToMatch(final Object[] match) {
      try {
          return SecurityDomain_physicalLocation.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected SecurityDomain_physicalLocation.Match arrayToMatchMutable(final Object[] match) {
      try {
          return SecurityDomain_physicalLocation.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<SecurityDomain_physicalLocation.Matcher> querySpecification() {
      return SecurityDomain_physicalLocation.instance();
    }
  }
  
  private SecurityDomain_physicalLocation() {
   ...
   * 
   */
  public static SecurityDomain_physicalLocation instance() {
    try{
  ...
  @Override
  protected SecurityDomain_physicalLocation.Matcher instantiate(final ViatraQueryEngine engine) {
    return SecurityDomain_physicalLocation.Matcher.on(engine);
  }
  
  @Override
  public SecurityDomain_physicalLocation.Matcher instantiate() {
    return SecurityDomain_physicalLocation.Matcher.create();
  }
  
  @Override
  public SecurityDomain_physicalLocation.Match newEmptyMatch() {
    return SecurityDomain_physicalLocation.Match.newEmptyMatch();
  }
  
  @Override
  public SecurityDomain_physicalLocation.Match newMatch(final Object... parameters) {
    return SecurityDomain_physicalLocation.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link SecurityDomain_physicalLocation} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link SecurityDomain_physicalLocation#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final SecurityDomain_physicalLocation INSTANCE = new SecurityDomain_physicalLocation();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final SecurityDomain_physicalLocation.GeneratedPQuery INSTANCE = new GeneratedPQuery();
