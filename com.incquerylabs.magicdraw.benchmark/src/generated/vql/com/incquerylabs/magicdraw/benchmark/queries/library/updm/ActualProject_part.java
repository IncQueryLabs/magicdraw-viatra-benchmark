...
public final class ActualProject_part extends BaseGeneratedEMFQuerySpecification<ActualProject_part.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ActualProject_part pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.ActualProject_part";
    }
    
    @Override
    public List<String> parameterNames() {
      return ActualProject_part.Match.parameterNames;
    }
    ...
    @Override
    public ActualProject_part.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ActualProject_part.Match)) {
          ActualProject_part.Match other = (ActualProject_part.Match) obj;
    ...
    @Override
    public ActualProject_part specification() {
      return ActualProject_part.instance();
    }
     ...
     * 
     */
    public static ActualProject_part.Match newEmptyMatch() {
     ...
     * 
     */
    public static ActualProject_part.Match newMutableMatch(final InstanceSpecification pElement, final InstanceSpecification pValue) {
     ...
     * 
     */
    public static ActualProject_part.Match newMatch(final InstanceSpecification pElement, final InstanceSpecification pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends ActualProject_part.Match {
    ...
    private static final class Immutable extends ActualProject_part.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ActualProject_part pattern,
   ...
   * 
   * @see Match
   * @see ActualProject_part
   * 
   */
  public static class Matcher extends BaseMatcher<ActualProject_part.Match> {
    /**
     ...
     * 
     */
    public static ActualProject_part.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ActualProject_part.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ActualProject_part.Matcher.class);
     ...
     * 
     */
    public Collection<ActualProject_part.Match> getAllMatches(final InstanceSpecification pElement, final InstanceSpecification pValue) {
     ...
     * 
     */
    public Stream<ActualProject_part.Match> streamAllMatches(final InstanceSpecification pElement, final InstanceSpecification pValue) {
     ...
     * 
     */
    public Optional<ActualProject_part.Match> getOneArbitraryMatch(final InstanceSpecification pElement, final InstanceSpecification pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final InstanceSpecification pElement, final InstanceSpecification pValue, final Consumer<? super ActualProject_part.Match> processor) {
     ...
     * 
     */
    public ActualProject_part.Match newMatch(final InstanceSpecification pElement, final InstanceSpecification pValue) {
      return ActualProject_part.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfelement(final ActualProject_part.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfelement(final ActualProject_part.Match partialMatch) {
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfvalue(final ActualProject_part.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfvalue(final ActualProject_part.Match partialMatch) {
    ...
    @Override
    protected ActualProject_part.Match tupleToMatch(final Tuple t) {
      try {
          return ActualProject_part.Match.newMatch((InstanceSpecification) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_VALUE));
    ...
    @Override
    protected ActualProject_part.Match arrayToMatch(final Object[] match) {
      try {
          return ActualProject_part.Match.newMatch((InstanceSpecification) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ActualProject_part.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ActualProject_part.Match.newMutableMatch((InstanceSpecification) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ActualProject_part.Matcher> querySpecification() {
      return ActualProject_part.instance();
    }
  }
  
  private ActualProject_part() {
   ...
   * 
   */
  public static ActualProject_part instance() {
    try{
  ...
  @Override
  protected ActualProject_part.Matcher instantiate(final ViatraQueryEngine engine) {
    return ActualProject_part.Matcher.on(engine);
  }
  
  @Override
  public ActualProject_part.Matcher instantiate() {
    return ActualProject_part.Matcher.create();
  }
  
  @Override
  public ActualProject_part.Match newEmptyMatch() {
    return ActualProject_part.Match.newEmptyMatch();
  }
  
  @Override
  public ActualProject_part.Match newMatch(final Object... parameters) {
    return ActualProject_part.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ActualProject_part} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ActualProject_part#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ActualProject_part INSTANCE = new ActualProject_part();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ActualProject_part.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          new ConstantValue(body, var__virtual_0_, "part");
