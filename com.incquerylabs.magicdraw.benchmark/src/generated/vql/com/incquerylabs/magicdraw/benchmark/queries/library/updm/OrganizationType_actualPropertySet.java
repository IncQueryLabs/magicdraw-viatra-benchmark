...
public final class OrganizationType_actualPropertySet extends BaseGeneratedEMFQuerySpecification<OrganizationType_actualPropertySet.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.OrganizationType_actualPropertySet pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.OrganizationType_actualPropertySet";
    }
    
    @Override
    public List<String> parameterNames() {
      return OrganizationType_actualPropertySet.Match.parameterNames;
    }
    ...
    @Override
    public OrganizationType_actualPropertySet.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof OrganizationType_actualPropertySet.Match)) {
          OrganizationType_actualPropertySet.Match other = (OrganizationType_actualPropertySet.Match) obj;
    ...
    @Override
    public OrganizationType_actualPropertySet specification() {
      return OrganizationType_actualPropertySet.instance();
    }
     ...
     * 
     */
    public static OrganizationType_actualPropertySet.Match newEmptyMatch() {
     ...
     * 
     */
    public static OrganizationType_actualPropertySet.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static OrganizationType_actualPropertySet.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends OrganizationType_actualPropertySet.Match {
    ...
    private static final class Immutable extends OrganizationType_actualPropertySet.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.OrganizationType_actualPropertySet pattern,
   ...
   * 
   * @see Match
   * @see OrganizationType_actualPropertySet
   * 
   */
  public static class Matcher extends BaseMatcher<OrganizationType_actualPropertySet.Match> {
    /**
     ...
     * 
     */
    public static OrganizationType_actualPropertySet.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static OrganizationType_actualPropertySet.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(OrganizationType_actualPropertySet.Matcher.class);
     ...
     * 
     */
    public Collection<OrganizationType_actualPropertySet.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<OrganizationType_actualPropertySet.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<OrganizationType_actualPropertySet.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super OrganizationType_actualPropertySet.Match> processor) {
     ...
     * 
     */
    public OrganizationType_actualPropertySet.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return OrganizationType_actualPropertySet.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final OrganizationType_actualPropertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final OrganizationType_actualPropertySet.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final OrganizationType_actualPropertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final OrganizationType_actualPropertySet.Match partialMatch) {
    ...
    @Override
    protected OrganizationType_actualPropertySet.Match tupleToMatch(final Tuple t) {
      try {
          return OrganizationType_actualPropertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected OrganizationType_actualPropertySet.Match arrayToMatch(final Object[] match) {
      try {
          return OrganizationType_actualPropertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected OrganizationType_actualPropertySet.Match arrayToMatchMutable(final Object[] match) {
      try {
          return OrganizationType_actualPropertySet.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<OrganizationType_actualPropertySet.Matcher> querySpecification() {
      return OrganizationType_actualPropertySet.instance();
    }
  }
  
  private OrganizationType_actualPropertySet() {
   ...
   * 
   */
  public static OrganizationType_actualPropertySet instance() {
    try{
  ...
  @Override
  protected OrganizationType_actualPropertySet.Matcher instantiate(final ViatraQueryEngine engine) {
    return OrganizationType_actualPropertySet.Matcher.on(engine);
  }
  
  @Override
  public OrganizationType_actualPropertySet.Matcher instantiate() {
    return OrganizationType_actualPropertySet.Matcher.create();
  }
  
  @Override
  public OrganizationType_actualPropertySet.Match newEmptyMatch() {
    return OrganizationType_actualPropertySet.Match.newEmptyMatch();
  }
  
  @Override
  public OrganizationType_actualPropertySet.Match newMatch(final Object... parameters) {
    return OrganizationType_actualPropertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link OrganizationType_actualPropertySet} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link OrganizationType_actualPropertySet#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final OrganizationType_actualPropertySet INSTANCE = new OrganizationType_actualPropertySet();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final OrganizationType_actualPropertySet.GeneratedPQuery INSTANCE = new GeneratedPQuery();
