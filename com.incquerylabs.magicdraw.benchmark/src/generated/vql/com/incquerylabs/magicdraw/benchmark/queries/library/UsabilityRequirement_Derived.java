...
public final class UsabilityRequirement_Derived extends BaseGeneratedEMFQuerySpecification<UsabilityRequirement_Derived.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.usabilityRequirement_Derived pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.usabilityRequirement_Derived";
    }
    
    @Override
    public List<String> parameterNames() {
      return UsabilityRequirement_Derived.Match.parameterNames;
    }
    ...
    @Override
    public UsabilityRequirement_Derived.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof UsabilityRequirement_Derived.Match)) {
          UsabilityRequirement_Derived.Match other = (UsabilityRequirement_Derived.Match) obj;
    ...
    @Override
    public UsabilityRequirement_Derived specification() {
     ...
     * 
     */
    public static UsabilityRequirement_Derived.Match newEmptyMatch() {
     ...
     * 
     */
    public static UsabilityRequirement_Derived.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static UsabilityRequirement_Derived.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends UsabilityRequirement_Derived.Match {
    ...
    private static final class Immutable extends UsabilityRequirement_Derived.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.usabilityRequirement_Derived pattern,
   ...
   * 
   * @see Match
   * @see UsabilityRequirement_Derived
   * 
   */
  public static class Matcher extends BaseMatcher<UsabilityRequirement_Derived.Match> {
    /**
     ...
     * 
     */
    public static UsabilityRequirement_Derived.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static UsabilityRequirement_Derived.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(UsabilityRequirement_Derived.Matcher.class);
     ...
     * 
     */
    public Collection<UsabilityRequirement_Derived.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<UsabilityRequirement_Derived.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<UsabilityRequirement_Derived.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super UsabilityRequirement_Derived.Match> processor) {
     ...
     * 
     */
    public UsabilityRequirement_Derived.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return UsabilityRequirement_Derived.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfElement(final UsabilityRequirement_Derived.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfElement(final UsabilityRequirement_Derived.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfValue(final UsabilityRequirement_Derived.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfValue(final UsabilityRequirement_Derived.Match partialMatch) {
    ...
    @Override
    protected UsabilityRequirement_Derived.Match tupleToMatch(final Tuple t) {
      try {
          return UsabilityRequirement_Derived.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected UsabilityRequirement_Derived.Match arrayToMatch(final Object[] match) {
      try {
          return UsabilityRequirement_Derived.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected UsabilityRequirement_Derived.Match arrayToMatchMutable(final Object[] match) {
      try {
          return UsabilityRequirement_Derived.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<UsabilityRequirement_Derived.Matcher> querySpecification() {
      return UsabilityRequirement_Derived.instance();
    }
  }
  
  private UsabilityRequirement_Derived() {
   ...
   * 
   */
  public static UsabilityRequirement_Derived instance() {
    try{
  ...
  @Override
  protected UsabilityRequirement_Derived.Matcher instantiate(final ViatraQueryEngine engine) {
    return UsabilityRequirement_Derived.Matcher.on(engine);
  }
  
  @Override
  public UsabilityRequirement_Derived.Matcher instantiate() {
    return UsabilityRequirement_Derived.Matcher.create();
  }
  
  @Override
  public UsabilityRequirement_Derived.Match newEmptyMatch() {
    return UsabilityRequirement_Derived.Match.newEmptyMatch();
  }
  
  @Override
  public UsabilityRequirement_Derived.Match newMatch(final Object... parameters) {
    return UsabilityRequirement_Derived.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link UsabilityRequirement_Derived} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link UsabilityRequirement_Derived#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final UsabilityRequirement_Derived INSTANCE = new UsabilityRequirement_Derived();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final UsabilityRequirement_Derived.GeneratedPQuery INSTANCE = new GeneratedPQuery();
