...
public final class Control_URI extends BaseGeneratedEMFQuerySpecification<Control_URI.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Control_URI pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.Control_URI";
    }
    
    @Override
    public List<String> parameterNames() {
      return Control_URI.Match.parameterNames;
    }
    ...
    @Override
    public Control_URI.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Control_URI.Match)) {
          Control_URI.Match other = (Control_URI.Match) obj;
    ...
    @Override
    public Control_URI specification() {
      return Control_URI.instance();
    }
     ...
     * 
     */
    public static Control_URI.Match newEmptyMatch() {
     ...
     * 
     */
    public static Control_URI.Match newMutableMatch(final InformationFlow pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public static Control_URI.Match newMatch(final InformationFlow pElement, final LiteralString pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends Control_URI.Match {
    ...
    private static final class Immutable extends Control_URI.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Control_URI pattern,
   ...
   * 
   */
  public static class Matcher extends BaseMatcher<Control_URI.Match> {
    /**
     ...
     * 
     */
    public static Control_URI.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Control_URI.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Control_URI.Matcher.class);
     ...
     * 
     */
    public Collection<Control_URI.Match> getAllMatches(final InformationFlow pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Stream<Control_URI.Match> streamAllMatches(final InformationFlow pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Optional<Control_URI.Match> getOneArbitraryMatch(final InformationFlow pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final InformationFlow pElement, final LiteralString pValuespec, final Consumer<? super Control_URI.Match> processor) {
     ...
     * 
     */
    public Control_URI.Match newMatch(final InformationFlow pElement, final LiteralString pValuespec) {
      return Control_URI.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<InformationFlow> streamAllValuesOfelement(final Control_URI.Match partialMatch) {
     ...
     * 
     */
    public Set<InformationFlow> getAllValuesOfelement(final Control_URI.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralString> streamAllValuesOfvaluespec(final Control_URI.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralString> getAllValuesOfvaluespec(final Control_URI.Match partialMatch) {
    ...
    @Override
    protected Control_URI.Match tupleToMatch(final Tuple t) {
      try {
          return Control_URI.Match.newMatch((InformationFlow) t.get(POSITION_ELEMENT), (LiteralString) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected Control_URI.Match arrayToMatch(final Object[] match) {
      try {
          return Control_URI.Match.newMatch((InformationFlow) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Control_URI.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Control_URI.Match.newMutableMatch((InformationFlow) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Control_URI.Matcher> querySpecification() {
      return Control_URI.instance();
    }
  }
   ...
   * 
   */
  public static Control_URI instance() {
    try{
  ...
  @Override
  protected Control_URI.Matcher instantiate(final ViatraQueryEngine engine) {
    return Control_URI.Matcher.on(engine);
  }
  
  @Override
  public Control_URI.Matcher instantiate() {
    return Control_URI.Matcher.create();
  }
  
  @Override
  public Control_URI.Match newEmptyMatch() {
    return Control_URI.Match.newEmptyMatch();
  }
  
  @Override
  public Control_URI.Match newMatch(final Object... parameters) {
    return Control_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.auxiliaryconstructs.mdinformationflows.InformationFlow) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralString) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Control_URI} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Control_URI#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Control_URI INSTANCE = new Control_URI();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Control_URI.GeneratedPQuery INSTANCE = new GeneratedPQuery();
