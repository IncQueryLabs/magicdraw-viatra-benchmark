...
public final class ActualProjectMilestoneRole_endDate extends BaseGeneratedEMFQuerySpecification<ActualProjectMilestoneRole_endDate.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.ActualProjectMilestoneRole_endDate pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.ActualProjectMilestoneRole_endDate";
    }
    
    @Override
    public List<String> parameterNames() {
      return ActualProjectMilestoneRole_endDate.Match.parameterNames;
    }
    ...
    @Override
    public ActualProjectMilestoneRole_endDate.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ActualProjectMilestoneRole_endDate.Match)) {
          ActualProjectMilestoneRole_endDate.Match other = (ActualProjectMilestoneRole_endDate.Match) obj;
    ...
    @Override
    public ActualProjectMilestoneRole_endDate specification() {
      return ActualProjectMilestoneRole_endDate.instance();
    }
     ...
     * 
     */
    public static ActualProjectMilestoneRole_endDate.Match newEmptyMatch() {
     ...
     * 
     */
    public static ActualProjectMilestoneRole_endDate.Match newMutableMatch(final Slot pElement, final Element pValue) {
     ...
     * 
     */
    public static ActualProjectMilestoneRole_endDate.Match newMatch(final Slot pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends ActualProjectMilestoneRole_endDate.Match {
    ...
    private static final class Immutable extends ActualProjectMilestoneRole_endDate.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.ActualProjectMilestoneRole_endDate pattern,
   ...
   * 
   * @see Match
   * @see ActualProjectMilestoneRole_endDate
   * 
   */
  public static class Matcher extends BaseMatcher<ActualProjectMilestoneRole_endDate.Match> {
    /**
     ...
     * 
     */
    public static ActualProjectMilestoneRole_endDate.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ActualProjectMilestoneRole_endDate.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ActualProjectMilestoneRole_endDate.Matcher.class);
     ...
     * 
     */
    public Collection<ActualProjectMilestoneRole_endDate.Match> getAllMatches(final Slot pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<ActualProjectMilestoneRole_endDate.Match> streamAllMatches(final Slot pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<ActualProjectMilestoneRole_endDate.Match> getOneArbitraryMatch(final Slot pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Slot pElement, final Element pValue, final Consumer<? super ActualProjectMilestoneRole_endDate.Match> processor) {
     ...
     * 
     */
    public ActualProjectMilestoneRole_endDate.Match newMatch(final Slot pElement, final Element pValue) {
      return ActualProjectMilestoneRole_endDate.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Slot> streamAllValuesOfelement(final ActualProjectMilestoneRole_endDate.Match partialMatch) {
     ...
     * 
     */
    public Set<Slot> getAllValuesOfelement(final ActualProjectMilestoneRole_endDate.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final ActualProjectMilestoneRole_endDate.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final ActualProjectMilestoneRole_endDate.Match partialMatch) {
    ...
    @Override
    protected ActualProjectMilestoneRole_endDate.Match tupleToMatch(final Tuple t) {
      try {
          return ActualProjectMilestoneRole_endDate.Match.newMatch((Slot) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected ActualProjectMilestoneRole_endDate.Match arrayToMatch(final Object[] match) {
      try {
          return ActualProjectMilestoneRole_endDate.Match.newMatch((Slot) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ActualProjectMilestoneRole_endDate.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ActualProjectMilestoneRole_endDate.Match.newMutableMatch((Slot) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ActualProjectMilestoneRole_endDate.Matcher> querySpecification() {
      return ActualProjectMilestoneRole_endDate.instance();
    }
  }
  
  private ActualProjectMilestoneRole_endDate() {
   ...
   * 
   */
  public static ActualProjectMilestoneRole_endDate instance() {
    try{
  ...
  @Override
  protected ActualProjectMilestoneRole_endDate.Matcher instantiate(final ViatraQueryEngine engine) {
    return ActualProjectMilestoneRole_endDate.Matcher.on(engine);
  }
  
  @Override
  public ActualProjectMilestoneRole_endDate.Matcher instantiate() {
    return ActualProjectMilestoneRole_endDate.Matcher.create();
  }
  
  @Override
  public ActualProjectMilestoneRole_endDate.Match newEmptyMatch() {
    return ActualProjectMilestoneRole_endDate.Match.newEmptyMatch();
  }
  
  @Override
  public ActualProjectMilestoneRole_endDate.Match newMatch(final Object... parameters) {
    return ActualProjectMilestoneRole_endDate.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Slot) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ActualProjectMilestoneRole_endDate} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ActualProjectMilestoneRole_endDate#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ActualProjectMilestoneRole_endDate INSTANCE = new ActualProjectMilestoneRole_endDate();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ActualProjectMilestoneRole_endDate.GeneratedPQuery INSTANCE = new GeneratedPQuery();
