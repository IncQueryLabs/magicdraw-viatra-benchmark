...
public final class Satisfy_targetContext extends BaseGeneratedEMFQuerySpecification<Satisfy_targetContext.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.Satisfy_targetContext pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.Satisfy_targetContext";
    }
    
    @Override
    public List<String> parameterNames() {
      return Satisfy_targetContext.Match.parameterNames;
    }
    ...
    @Override
    public Satisfy_targetContext.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Satisfy_targetContext.Match)) {
          Satisfy_targetContext.Match other = (Satisfy_targetContext.Match) obj;
    ...
    @Override
    public Satisfy_targetContext specification() {
     ...
     * 
     */
    public static Satisfy_targetContext.Match newEmptyMatch() {
     ...
     * 
     */
    public static Satisfy_targetContext.Match newMutableMatch(final Abstraction pElement, final Classifier pValue) {
     ...
     * 
     */
    public static Satisfy_targetContext.Match newMatch(final Abstraction pElement, final Classifier pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Satisfy_targetContext.Match {
    ...
    private static final class Immutable extends Satisfy_targetContext.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.Satisfy_targetContext pattern,
   ...
   * 
   * @see Match
   * @see Satisfy_targetContext
   * 
   */
  public static class Matcher extends BaseMatcher<Satisfy_targetContext.Match> {
    /**
     ...
     * 
     */
    public static Satisfy_targetContext.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Satisfy_targetContext.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Satisfy_targetContext.Matcher.class);
     ...
     * 
     */
    public Collection<Satisfy_targetContext.Match> getAllMatches(final Abstraction pElement, final Classifier pValue) {
     ...
     * 
     */
    public Stream<Satisfy_targetContext.Match> streamAllMatches(final Abstraction pElement, final Classifier pValue) {
     ...
     * 
     */
    public Optional<Satisfy_targetContext.Match> getOneArbitraryMatch(final Abstraction pElement, final Classifier pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Abstraction pElement, final Classifier pValue, final Consumer<? super Satisfy_targetContext.Match> processor) {
     ...
     * 
     */
    public Satisfy_targetContext.Match newMatch(final Abstraction pElement, final Classifier pValue) {
      return Satisfy_targetContext.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Abstraction> streamAllValuesOfelement(final Satisfy_targetContext.Match partialMatch) {
     ...
     * 
     */
    public Set<Abstraction> getAllValuesOfelement(final Satisfy_targetContext.Match partialMatch) {
     ...
     * 
     */
    public Stream<Classifier> streamAllValuesOfvalue(final Satisfy_targetContext.Match partialMatch) {
     ...
     * 
     */
    public Set<Classifier> getAllValuesOfvalue(final Satisfy_targetContext.Match partialMatch) {
    ...
    @Override
    protected Satisfy_targetContext.Match tupleToMatch(final Tuple t) {
      try {
          return Satisfy_targetContext.Match.newMatch((Abstraction) t.get(POSITION_ELEMENT), (Classifier) t.get(POSITION_VALUE));
    ...
    @Override
    protected Satisfy_targetContext.Match arrayToMatch(final Object[] match) {
      try {
          return Satisfy_targetContext.Match.newMatch((Abstraction) match[POSITION_ELEMENT], (Classifier) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Satisfy_targetContext.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Satisfy_targetContext.Match.newMutableMatch((Abstraction) match[POSITION_ELEMENT], (Classifier) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Satisfy_targetContext.Matcher> querySpecification() {
      return Satisfy_targetContext.instance();
    }
  }
  
  private Satisfy_targetContext() {
   ...
   * 
   */
  public static Satisfy_targetContext instance() {
    try{
  ...
  @Override
  protected Satisfy_targetContext.Matcher instantiate(final ViatraQueryEngine engine) {
    return Satisfy_targetContext.Matcher.on(engine);
  }
  
  @Override
  public Satisfy_targetContext.Matcher instantiate() {
    return Satisfy_targetContext.Matcher.create();
  }
  
  @Override
  public Satisfy_targetContext.Match newEmptyMatch() {
    return Satisfy_targetContext.Match.newEmptyMatch();
  }
  
  @Override
  public Satisfy_targetContext.Match newMatch(final Object... parameters) {
    return Satisfy_targetContext.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mddependencies.Abstraction) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Classifier) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Satisfy_targetContext} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Satisfy_targetContext#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Satisfy_targetContext INSTANCE = new Satisfy_targetContext();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Satisfy_targetContext.GeneratedPQuery INSTANCE = new GeneratedPQuery();
