...
public final class RequirementRelated_Refines extends BaseGeneratedEMFQuerySpecification<RequirementRelated_Refines.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.RequirementRelated_Refines pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.RequirementRelated_Refines";
    }
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.RequirementRelated_Refines pattern,
