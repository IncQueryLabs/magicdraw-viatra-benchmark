...
public final class MapsToCapability_sourceContext extends BaseGeneratedEMFQuerySpecification<MapsToCapability_sourceContext.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.MapsToCapability_sourceContext pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.MapsToCapability_sourceContext";
    }
    
    @Override
    public List<String> parameterNames() {
      return MapsToCapability_sourceContext.Match.parameterNames;
    }
    ...
    @Override
    public MapsToCapability_sourceContext.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof MapsToCapability_sourceContext.Match)) {
          MapsToCapability_sourceContext.Match other = (MapsToCapability_sourceContext.Match) obj;
    ...
    @Override
    public MapsToCapability_sourceContext specification() {
      return MapsToCapability_sourceContext.instance();
    }
     ...
     * 
     */
    public static MapsToCapability_sourceContext.Match newEmptyMatch() {
     ...
     * 
     */
    public static MapsToCapability_sourceContext.Match newMutableMatch(final Abstraction pElement, final Classifier pValue) {
     ...
     * 
     */
    public static MapsToCapability_sourceContext.Match newMatch(final Abstraction pElement, final Classifier pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends MapsToCapability_sourceContext.Match {
    ...
    private static final class Immutable extends MapsToCapability_sourceContext.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.MapsToCapability_sourceContext pattern,
   ...
   * 
   * @see Match
   * @see MapsToCapability_sourceContext
   * 
   */
  public static class Matcher extends BaseMatcher<MapsToCapability_sourceContext.Match> {
    /**
     ...
     * 
     */
    public static MapsToCapability_sourceContext.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static MapsToCapability_sourceContext.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(MapsToCapability_sourceContext.Matcher.class);
     ...
     * 
     */
    public Collection<MapsToCapability_sourceContext.Match> getAllMatches(final Abstraction pElement, final Classifier pValue) {
     ...
     * 
     */
    public Stream<MapsToCapability_sourceContext.Match> streamAllMatches(final Abstraction pElement, final Classifier pValue) {
     ...
     * 
     */
    public Optional<MapsToCapability_sourceContext.Match> getOneArbitraryMatch(final Abstraction pElement, final Classifier pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Abstraction pElement, final Classifier pValue, final Consumer<? super MapsToCapability_sourceContext.Match> processor) {
     ...
     * 
     */
    public MapsToCapability_sourceContext.Match newMatch(final Abstraction pElement, final Classifier pValue) {
      return MapsToCapability_sourceContext.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Abstraction> streamAllValuesOfelement(final MapsToCapability_sourceContext.Match partialMatch) {
     ...
     * 
     */
    public Set<Abstraction> getAllValuesOfelement(final MapsToCapability_sourceContext.Match partialMatch) {
     ...
     * 
     */
    public Stream<Classifier> streamAllValuesOfvalue(final MapsToCapability_sourceContext.Match partialMatch) {
     ...
     * 
     */
    public Set<Classifier> getAllValuesOfvalue(final MapsToCapability_sourceContext.Match partialMatch) {
    ...
    @Override
    protected MapsToCapability_sourceContext.Match tupleToMatch(final Tuple t) {
      try {
          return MapsToCapability_sourceContext.Match.newMatch((Abstraction) t.get(POSITION_ELEMENT), (Classifier) t.get(POSITION_VALUE));
    ...
    @Override
    protected MapsToCapability_sourceContext.Match arrayToMatch(final Object[] match) {
      try {
          return MapsToCapability_sourceContext.Match.newMatch((Abstraction) match[POSITION_ELEMENT], (Classifier) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected MapsToCapability_sourceContext.Match arrayToMatchMutable(final Object[] match) {
      try {
          return MapsToCapability_sourceContext.Match.newMutableMatch((Abstraction) match[POSITION_ELEMENT], (Classifier) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<MapsToCapability_sourceContext.Matcher> querySpecification() {
      return MapsToCapability_sourceContext.instance();
    }
  }
  
  private MapsToCapability_sourceContext() {
   ...
   * 
   */
  public static MapsToCapability_sourceContext instance() {
    try{
  ...
  @Override
  protected MapsToCapability_sourceContext.Matcher instantiate(final ViatraQueryEngine engine) {
    return MapsToCapability_sourceContext.Matcher.on(engine);
  }
  
  @Override
  public MapsToCapability_sourceContext.Matcher instantiate() {
    return MapsToCapability_sourceContext.Matcher.create();
  }
  
  @Override
  public MapsToCapability_sourceContext.Match newEmptyMatch() {
    return MapsToCapability_sourceContext.Match.newEmptyMatch();
  }
  
  @Override
  public MapsToCapability_sourceContext.Match newMatch(final Object... parameters) {
    return MapsToCapability_sourceContext.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mddependencies.Abstraction) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Classifier) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link MapsToCapability_sourceContext} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link MapsToCapability_sourceContext#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final MapsToCapability_sourceContext INSTANCE = new MapsToCapability_sourceContext();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final MapsToCapability_sourceContext.GeneratedPQuery INSTANCE = new GeneratedPQuery();
