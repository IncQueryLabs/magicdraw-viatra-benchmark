...
public final class EntityAttribute_conformsTo extends BaseGeneratedEMFQuerySpecification<EntityAttribute_conformsTo.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.EntityAttribute_conformsTo pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.EntityAttribute_conformsTo";
    }
    
    @Override
    public List<String> parameterNames() {
      return EntityAttribute_conformsTo.Match.parameterNames;
    }
    ...
    @Override
    public EntityAttribute_conformsTo.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof EntityAttribute_conformsTo.Match)) {
          EntityAttribute_conformsTo.Match other = (EntityAttribute_conformsTo.Match) obj;
    ...
    @Override
    public EntityAttribute_conformsTo specification() {
      return EntityAttribute_conformsTo.instance();
    }
     ...
     * 
     */
    public static EntityAttribute_conformsTo.Match newEmptyMatch() {
     ...
     * 
     */
    public static EntityAttribute_conformsTo.Match newMutableMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public static EntityAttribute_conformsTo.Match newMatch(final Property pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends EntityAttribute_conformsTo.Match {
    ...
    private static final class Immutable extends EntityAttribute_conformsTo.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.EntityAttribute_conformsTo pattern,
   ...
   * 
   * @see Match
   * @see EntityAttribute_conformsTo
   * 
   */
  public static class Matcher extends BaseMatcher<EntityAttribute_conformsTo.Match> {
    /**
     ...
     * 
     */
    public static EntityAttribute_conformsTo.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static EntityAttribute_conformsTo.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(EntityAttribute_conformsTo.Matcher.class);
     ...
     * 
     */
    public Collection<EntityAttribute_conformsTo.Match> getAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<EntityAttribute_conformsTo.Match> streamAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<EntityAttribute_conformsTo.Match> getOneArbitraryMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final Element pValue, final Consumer<? super EntityAttribute_conformsTo.Match> processor) {
     ...
     * 
     */
    public EntityAttribute_conformsTo.Match newMatch(final Property pElement, final Element pValue) {
      return EntityAttribute_conformsTo.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfelement(final EntityAttribute_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfelement(final EntityAttribute_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final EntityAttribute_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final EntityAttribute_conformsTo.Match partialMatch) {
    ...
    @Override
    protected EntityAttribute_conformsTo.Match tupleToMatch(final Tuple t) {
      try {
          return EntityAttribute_conformsTo.Match.newMatch((Property) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected EntityAttribute_conformsTo.Match arrayToMatch(final Object[] match) {
      try {
          return EntityAttribute_conformsTo.Match.newMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected EntityAttribute_conformsTo.Match arrayToMatchMutable(final Object[] match) {
      try {
          return EntityAttribute_conformsTo.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<EntityAttribute_conformsTo.Matcher> querySpecification() {
      return EntityAttribute_conformsTo.instance();
    }
  }
  
  private EntityAttribute_conformsTo() {
   ...
   * 
   */
  public static EntityAttribute_conformsTo instance() {
    try{
  ...
  @Override
  protected EntityAttribute_conformsTo.Matcher instantiate(final ViatraQueryEngine engine) {
    return EntityAttribute_conformsTo.Matcher.on(engine);
  }
  
  @Override
  public EntityAttribute_conformsTo.Matcher instantiate() {
    return EntityAttribute_conformsTo.Matcher.create();
  }
  
  @Override
  public EntityAttribute_conformsTo.Match newEmptyMatch() {
    return EntityAttribute_conformsTo.Match.newEmptyMatch();
  }
  
  @Override
  public EntityAttribute_conformsTo.Match newMatch(final Object... parameters) {
    return EntityAttribute_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link EntityAttribute_conformsTo} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link EntityAttribute_conformsTo#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final EntityAttribute_conformsTo INSTANCE = new EntityAttribute_conformsTo();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final EntityAttribute_conformsTo.GeneratedPQuery INSTANCE = new GeneratedPQuery();
