...
public final class VersionOfConfiguration_URI extends BaseGeneratedEMFQuerySpecification<VersionOfConfiguration_URI.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.VersionOfConfiguration_URI pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.VersionOfConfiguration_URI";
    }
    
    @Override
    public List<String> parameterNames() {
      return VersionOfConfiguration_URI.Match.parameterNames;
    }
    ...
    @Override
    public VersionOfConfiguration_URI.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof VersionOfConfiguration_URI.Match)) {
          VersionOfConfiguration_URI.Match other = (VersionOfConfiguration_URI.Match) obj;
    ...
    @Override
    public VersionOfConfiguration_URI specification() {
      return VersionOfConfiguration_URI.instance();
    }
     ...
     * 
     */
    public static VersionOfConfiguration_URI.Match newEmptyMatch() {
     ...
     * 
     */
    public static VersionOfConfiguration_URI.Match newMutableMatch(final Property pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public static VersionOfConfiguration_URI.Match newMatch(final Property pElement, final LiteralString pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends VersionOfConfiguration_URI.Match {
    ...
    private static final class Immutable extends VersionOfConfiguration_URI.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.VersionOfConfiguration_URI pattern,
   ...
   * 
   * @see Match
   * @see VersionOfConfiguration_URI
   * 
   */
  public static class Matcher extends BaseMatcher<VersionOfConfiguration_URI.Match> {
    /**
     ...
     * 
     */
    public static VersionOfConfiguration_URI.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static VersionOfConfiguration_URI.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(VersionOfConfiguration_URI.Matcher.class);
     ...
     * 
     */
    public Collection<VersionOfConfiguration_URI.Match> getAllMatches(final Property pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Stream<VersionOfConfiguration_URI.Match> streamAllMatches(final Property pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Optional<VersionOfConfiguration_URI.Match> getOneArbitraryMatch(final Property pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final LiteralString pValuespec, final Consumer<? super VersionOfConfiguration_URI.Match> processor) {
     ...
     * 
     */
    public VersionOfConfiguration_URI.Match newMatch(final Property pElement, final LiteralString pValuespec) {
      return VersionOfConfiguration_URI.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfelement(final VersionOfConfiguration_URI.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfelement(final VersionOfConfiguration_URI.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralString> streamAllValuesOfvaluespec(final VersionOfConfiguration_URI.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralString> getAllValuesOfvaluespec(final VersionOfConfiguration_URI.Match partialMatch) {
    ...
    @Override
    protected VersionOfConfiguration_URI.Match tupleToMatch(final Tuple t) {
      try {
          return VersionOfConfiguration_URI.Match.newMatch((Property) t.get(POSITION_ELEMENT), (LiteralString) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected VersionOfConfiguration_URI.Match arrayToMatch(final Object[] match) {
      try {
          return VersionOfConfiguration_URI.Match.newMatch((Property) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected VersionOfConfiguration_URI.Match arrayToMatchMutable(final Object[] match) {
      try {
          return VersionOfConfiguration_URI.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<VersionOfConfiguration_URI.Matcher> querySpecification() {
      return VersionOfConfiguration_URI.instance();
    }
  }
  
  private VersionOfConfiguration_URI() {
   ...
   * 
   */
  public static VersionOfConfiguration_URI instance() {
    try{
  ...
  @Override
  protected VersionOfConfiguration_URI.Matcher instantiate(final ViatraQueryEngine engine) {
    return VersionOfConfiguration_URI.Matcher.on(engine);
  }
  
  @Override
  public VersionOfConfiguration_URI.Matcher instantiate() {
    return VersionOfConfiguration_URI.Matcher.create();
  }
  
  @Override
  public VersionOfConfiguration_URI.Match newEmptyMatch() {
    return VersionOfConfiguration_URI.Match.newEmptyMatch();
  }
  
  @Override
  public VersionOfConfiguration_URI.Match newMatch(final Object... parameters) {
    return VersionOfConfiguration_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralString) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link VersionOfConfiguration_URI} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link VersionOfConfiguration_URI#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final VersionOfConfiguration_URI INSTANCE = new VersionOfConfiguration_URI();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final VersionOfConfiguration_URI.GeneratedPQuery INSTANCE = new GeneratedPQuery();
