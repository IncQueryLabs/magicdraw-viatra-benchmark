...
public final class KnownResource_categoryCategorizesAsset extends BaseGeneratedEMFQuerySpecification<KnownResource_categoryCategorizesAsset.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.KnownResource_categoryCategorizesAsset pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.KnownResource_categoryCategorizesAsset";
    }
    
    @Override
    public List<String> parameterNames() {
      return KnownResource_categoryCategorizesAsset.Match.parameterNames;
    }
    ...
    @Override
    public KnownResource_categoryCategorizesAsset.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof KnownResource_categoryCategorizesAsset.Match)) {
          KnownResource_categoryCategorizesAsset.Match other = (KnownResource_categoryCategorizesAsset.Match) obj;
    ...
    @Override
    public KnownResource_categoryCategorizesAsset specification() {
      return KnownResource_categoryCategorizesAsset.instance();
    }
     ...
     * 
     */
    public static KnownResource_categoryCategorizesAsset.Match newEmptyMatch() {
     ...
     * 
     */
    public static KnownResource_categoryCategorizesAsset.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static KnownResource_categoryCategorizesAsset.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends KnownResource_categoryCategorizesAsset.Match {
    ...
    private static final class Immutable extends KnownResource_categoryCategorizesAsset.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.KnownResource_categoryCategorizesAsset pattern,
   ...
   * 
   * @see Match
   * @see KnownResource_categoryCategorizesAsset
   * 
   */
  public static class Matcher extends BaseMatcher<KnownResource_categoryCategorizesAsset.Match> {
    /**
     ...
     * 
     */
    public static KnownResource_categoryCategorizesAsset.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static KnownResource_categoryCategorizesAsset.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(KnownResource_categoryCategorizesAsset.Matcher.class);
     ...
     * 
     */
    public Collection<KnownResource_categoryCategorizesAsset.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<KnownResource_categoryCategorizesAsset.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<KnownResource_categoryCategorizesAsset.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super KnownResource_categoryCategorizesAsset.Match> processor) {
     ...
     * 
     */
    public KnownResource_categoryCategorizesAsset.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return KnownResource_categoryCategorizesAsset.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final KnownResource_categoryCategorizesAsset.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final KnownResource_categoryCategorizesAsset.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final KnownResource_categoryCategorizesAsset.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final KnownResource_categoryCategorizesAsset.Match partialMatch) {
    ...
    @Override
    protected KnownResource_categoryCategorizesAsset.Match tupleToMatch(final Tuple t) {
      try {
          return KnownResource_categoryCategorizesAsset.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected KnownResource_categoryCategorizesAsset.Match arrayToMatch(final Object[] match) {
      try {
          return KnownResource_categoryCategorizesAsset.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected KnownResource_categoryCategorizesAsset.Match arrayToMatchMutable(final Object[] match) {
      try {
          return KnownResource_categoryCategorizesAsset.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<KnownResource_categoryCategorizesAsset.Matcher> querySpecification() {
      return KnownResource_categoryCategorizesAsset.instance();
    }
  }
  
  private KnownResource_categoryCategorizesAsset() {
   ...
   * 
   */
  public static KnownResource_categoryCategorizesAsset instance() {
    try{
  ...
  @Override
  protected KnownResource_categoryCategorizesAsset.Matcher instantiate(final ViatraQueryEngine engine) {
    return KnownResource_categoryCategorizesAsset.Matcher.on(engine);
  }
  
  @Override
  public KnownResource_categoryCategorizesAsset.Matcher instantiate() {
    return KnownResource_categoryCategorizesAsset.Matcher.create();
  }
  
  @Override
  public KnownResource_categoryCategorizesAsset.Match newEmptyMatch() {
    return KnownResource_categoryCategorizesAsset.Match.newEmptyMatch();
  }
  
  @Override
  public KnownResource_categoryCategorizesAsset.Match newMatch(final Object... parameters) {
    return KnownResource_categoryCategorizesAsset.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link KnownResource_categoryCategorizesAsset} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link KnownResource_categoryCategorizesAsset#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final KnownResource_categoryCategorizesAsset INSTANCE = new KnownResource_categoryCategorizesAsset();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final KnownResource_categoryCategorizesAsset.GeneratedPQuery INSTANCE = new GeneratedPQuery();
