...
public final class NaturalResource_categoryCategorizesAsset extends BaseGeneratedEMFQuerySpecification<NaturalResource_categoryCategorizesAsset.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.NaturalResource_categoryCategorizesAsset pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.NaturalResource_categoryCategorizesAsset";
    }
    
    @Override
    public List<String> parameterNames() {
      return NaturalResource_categoryCategorizesAsset.Match.parameterNames;
    }
    ...
    @Override
    public NaturalResource_categoryCategorizesAsset.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof NaturalResource_categoryCategorizesAsset.Match)) {
          NaturalResource_categoryCategorizesAsset.Match other = (NaturalResource_categoryCategorizesAsset.Match) obj;
    ...
    @Override
    public NaturalResource_categoryCategorizesAsset specification() {
      return NaturalResource_categoryCategorizesAsset.instance();
    }
     ...
     * 
     */
    public static NaturalResource_categoryCategorizesAsset.Match newEmptyMatch() {
     ...
     * 
     */
    public static NaturalResource_categoryCategorizesAsset.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static NaturalResource_categoryCategorizesAsset.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends NaturalResource_categoryCategorizesAsset.Match {
    ...
    private static final class Immutable extends NaturalResource_categoryCategorizesAsset.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.NaturalResource_categoryCategorizesAsset pattern,
   ...
   * 
   * @see Match
   * @see NaturalResource_categoryCategorizesAsset
   * 
   */
  public static class Matcher extends BaseMatcher<NaturalResource_categoryCategorizesAsset.Match> {
    /**
     ...
     * 
     */
    public static NaturalResource_categoryCategorizesAsset.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static NaturalResource_categoryCategorizesAsset.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(NaturalResource_categoryCategorizesAsset.Matcher.class);
     ...
     * 
     */
    public Collection<NaturalResource_categoryCategorizesAsset.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<NaturalResource_categoryCategorizesAsset.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<NaturalResource_categoryCategorizesAsset.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super NaturalResource_categoryCategorizesAsset.Match> processor) {
     ...
     * 
     */
    public NaturalResource_categoryCategorizesAsset.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return NaturalResource_categoryCategorizesAsset.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final NaturalResource_categoryCategorizesAsset.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final NaturalResource_categoryCategorizesAsset.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final NaturalResource_categoryCategorizesAsset.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final NaturalResource_categoryCategorizesAsset.Match partialMatch) {
    ...
    @Override
    protected NaturalResource_categoryCategorizesAsset.Match tupleToMatch(final Tuple t) {
      try {
          return NaturalResource_categoryCategorizesAsset.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected NaturalResource_categoryCategorizesAsset.Match arrayToMatch(final Object[] match) {
      try {
          return NaturalResource_categoryCategorizesAsset.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected NaturalResource_categoryCategorizesAsset.Match arrayToMatchMutable(final Object[] match) {
      try {
          return NaturalResource_categoryCategorizesAsset.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<NaturalResource_categoryCategorizesAsset.Matcher> querySpecification() {
      return NaturalResource_categoryCategorizesAsset.instance();
    }
  }
  
  private NaturalResource_categoryCategorizesAsset() {
   ...
   * 
   */
  public static NaturalResource_categoryCategorizesAsset instance() {
    try{
  ...
  @Override
  protected NaturalResource_categoryCategorizesAsset.Matcher instantiate(final ViatraQueryEngine engine) {
    return NaturalResource_categoryCategorizesAsset.Matcher.on(engine);
  }
  
  @Override
  public NaturalResource_categoryCategorizesAsset.Matcher instantiate() {
    return NaturalResource_categoryCategorizesAsset.Matcher.create();
  }
  
  @Override
  public NaturalResource_categoryCategorizesAsset.Match newEmptyMatch() {
    return NaturalResource_categoryCategorizesAsset.Match.newEmptyMatch();
  }
  
  @Override
  public NaturalResource_categoryCategorizesAsset.Match newMatch(final Object... parameters) {
    return NaturalResource_categoryCategorizesAsset.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link NaturalResource_categoryCategorizesAsset} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link NaturalResource_categoryCategorizesAsset#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final NaturalResource_categoryCategorizesAsset INSTANCE = new NaturalResource_categoryCategorizesAsset();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final NaturalResource_categoryCategorizesAsset.GeneratedPQuery INSTANCE = new GeneratedPQuery();
