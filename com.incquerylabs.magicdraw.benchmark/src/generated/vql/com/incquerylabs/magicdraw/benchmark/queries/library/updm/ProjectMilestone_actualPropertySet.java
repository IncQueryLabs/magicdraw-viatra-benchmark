...
import com.incquerylabs.magicdraw.benchmark.queries.library.updm.ProjectMilestone;
...
public final class ProjectMilestone_actualPropertySet extends BaseGeneratedEMFQuerySpecification<ProjectMilestone_actualPropertySet.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ProjectMilestone_actualPropertySet pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.ProjectMilestone_actualPropertySet";
    }
    
    @Override
    public List<String> parameterNames() {
      return ProjectMilestone_actualPropertySet.Match.parameterNames;
    }
    ...
    @Override
    public ProjectMilestone_actualPropertySet.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ProjectMilestone_actualPropertySet.Match)) {
          ProjectMilestone_actualPropertySet.Match other = (ProjectMilestone_actualPropertySet.Match) obj;
    ...
    @Override
    public ProjectMilestone_actualPropertySet specification() {
      return ProjectMilestone_actualPropertySet.instance();
    }
     ...
     * 
     */
    public static ProjectMilestone_actualPropertySet.Match newEmptyMatch() {
     ...
     * 
     */
    public static ProjectMilestone_actualPropertySet.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static ProjectMilestone_actualPropertySet.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends ProjectMilestone_actualPropertySet.Match {
    ...
    private static final class Immutable extends ProjectMilestone_actualPropertySet.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ProjectMilestone_actualPropertySet pattern,
   ...
   * 
   * @see Match
   * @see ProjectMilestone_actualPropertySet
   * 
   */
  public static class Matcher extends BaseMatcher<ProjectMilestone_actualPropertySet.Match> {
    /**
     ...
     * 
     */
    public static ProjectMilestone_actualPropertySet.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ProjectMilestone_actualPropertySet.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ProjectMilestone_actualPropertySet.Matcher.class);
     ...
     * 
     */
    public Collection<ProjectMilestone_actualPropertySet.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<ProjectMilestone_actualPropertySet.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<ProjectMilestone_actualPropertySet.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super ProjectMilestone_actualPropertySet.Match> processor) {
     ...
     * 
     */
    public ProjectMilestone_actualPropertySet.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return ProjectMilestone_actualPropertySet.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final ProjectMilestone_actualPropertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final ProjectMilestone_actualPropertySet.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final ProjectMilestone_actualPropertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final ProjectMilestone_actualPropertySet.Match partialMatch) {
    ...
    @Override
    protected ProjectMilestone_actualPropertySet.Match tupleToMatch(final Tuple t) {
      try {
          return ProjectMilestone_actualPropertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected ProjectMilestone_actualPropertySet.Match arrayToMatch(final Object[] match) {
      try {
          return ProjectMilestone_actualPropertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ProjectMilestone_actualPropertySet.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ProjectMilestone_actualPropertySet.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ProjectMilestone_actualPropertySet.Matcher> querySpecification() {
      return ProjectMilestone_actualPropertySet.instance();
    }
  }
  
  private ProjectMilestone_actualPropertySet() {
   ...
   * 
   */
  public static ProjectMilestone_actualPropertySet instance() {
    try{
  ...
  @Override
  protected ProjectMilestone_actualPropertySet.Matcher instantiate(final ViatraQueryEngine engine) {
    return ProjectMilestone_actualPropertySet.Matcher.on(engine);
  }
  
  @Override
  public ProjectMilestone_actualPropertySet.Matcher instantiate() {
    return ProjectMilestone_actualPropertySet.Matcher.create();
  }
  
  @Override
  public ProjectMilestone_actualPropertySet.Match newEmptyMatch() {
    return ProjectMilestone_actualPropertySet.Match.newEmptyMatch();
  }
  
  @Override
  public ProjectMilestone_actualPropertySet.Match newMatch(final Object... parameters) {
    return ProjectMilestone_actualPropertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ProjectMilestone_actualPropertySet} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ProjectMilestone_actualPropertySet#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ProjectMilestone_actualPropertySet INSTANCE = new ProjectMilestone_actualPropertySet();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ProjectMilestone_actualPropertySet.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find ProjectMilestone(element, domainStereotypeInstance)
          new PositivePatternCall(body, Tuples.flatTupleOf(var_element, var_domainStereotypeInstance), ProjectMilestone.instance().getInternalQueryRepresentation());
          // 	find com.incquerylabs.magicdraw.benchmark.queries.library.slotValue(domainStereotypeInstance, "actualPropertySet", valuespec)
