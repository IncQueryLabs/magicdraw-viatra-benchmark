...
import com.incquerylabs.magicdraw.benchmark.queries.library.OperationalInterface;
...
public final class OperationalInterface_isEncapsulated extends BaseGeneratedEMFQuerySpecification<OperationalInterface_isEncapsulated.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.OperationalInterface_isEncapsulated pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.OperationalInterface_isEncapsulated";
    }
    
    @Override
    public List<String> parameterNames() {
      return OperationalInterface_isEncapsulated.Match.parameterNames;
    }
    ...
    @Override
    public OperationalInterface_isEncapsulated.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof OperationalInterface_isEncapsulated.Match)) {
          OperationalInterface_isEncapsulated.Match other = (OperationalInterface_isEncapsulated.Match) obj;
    ...
    @Override
    public OperationalInterface_isEncapsulated specification() {
      return OperationalInterface_isEncapsulated.instance();
    }
     ...
     * 
     */
    public static OperationalInterface_isEncapsulated.Match newEmptyMatch() {
     ...
     * 
     */
    public static OperationalInterface_isEncapsulated.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public static OperationalInterface_isEncapsulated.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends OperationalInterface_isEncapsulated.Match {
    ...
    private static final class Immutable extends OperationalInterface_isEncapsulated.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.OperationalInterface_isEncapsulated pattern,
   ...
   * 
   * @see Match
   * @see OperationalInterface_isEncapsulated
   * 
   */
  public static class Matcher extends BaseMatcher<OperationalInterface_isEncapsulated.Match> {
    /**
     ...
     * 
     */
    public static OperationalInterface_isEncapsulated.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static OperationalInterface_isEncapsulated.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(OperationalInterface_isEncapsulated.Matcher.class);
     ...
     * 
     */
    public Collection<OperationalInterface_isEncapsulated.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public Stream<OperationalInterface_isEncapsulated.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public Optional<OperationalInterface_isEncapsulated.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec, final Consumer<? super OperationalInterface_isEncapsulated.Match> processor) {
     ...
     * 
     */
    public OperationalInterface_isEncapsulated.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralBoolean pValuespec) {
      return OperationalInterface_isEncapsulated.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final OperationalInterface_isEncapsulated.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final OperationalInterface_isEncapsulated.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralBoolean> streamAllValuesOfvaluespec(final OperationalInterface_isEncapsulated.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralBoolean> getAllValuesOfvaluespec(final OperationalInterface_isEncapsulated.Match partialMatch) {
    ...
    @Override
    protected OperationalInterface_isEncapsulated.Match tupleToMatch(final Tuple t) {
      try {
          return OperationalInterface_isEncapsulated.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (LiteralBoolean) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected OperationalInterface_isEncapsulated.Match arrayToMatch(final Object[] match) {
      try {
          return OperationalInterface_isEncapsulated.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralBoolean) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected OperationalInterface_isEncapsulated.Match arrayToMatchMutable(final Object[] match) {
      try {
          return OperationalInterface_isEncapsulated.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralBoolean) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<OperationalInterface_isEncapsulated.Matcher> querySpecification() {
      return OperationalInterface_isEncapsulated.instance();
    }
  }
  
  private OperationalInterface_isEncapsulated() {
   ...
   * 
   */
  public static OperationalInterface_isEncapsulated instance() {
    try{
  ...
  @Override
  protected OperationalInterface_isEncapsulated.Matcher instantiate(final ViatraQueryEngine engine) {
    return OperationalInterface_isEncapsulated.Matcher.on(engine);
  }
  
  @Override
  public OperationalInterface_isEncapsulated.Matcher instantiate() {
    return OperationalInterface_isEncapsulated.Matcher.create();
  }
  
  @Override
  public OperationalInterface_isEncapsulated.Match newEmptyMatch() {
    return OperationalInterface_isEncapsulated.Match.newEmptyMatch();
  }
  
  @Override
  public OperationalInterface_isEncapsulated.Match newMatch(final Object... parameters) {
    return OperationalInterface_isEncapsulated.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralBoolean) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link OperationalInterface_isEncapsulated} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link OperationalInterface_isEncapsulated#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final OperationalInterface_isEncapsulated INSTANCE = new OperationalInterface_isEncapsulated();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final OperationalInterface_isEncapsulated.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find OperationalInterface(element, domainStereotypeInstance)
          new PositivePatternCall(body, Tuples.flatTupleOf(var_element, var_domainStereotypeInstance), OperationalInterface.instance().getInternalQueryRepresentation());
          // 	find slotValue(domainStereotypeInstance, "isEncapsulated", valuespec)
