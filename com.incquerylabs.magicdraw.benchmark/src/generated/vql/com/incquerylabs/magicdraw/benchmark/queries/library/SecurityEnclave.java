...
public final class SecurityEnclave extends BaseGeneratedEMFQuerySpecification<SecurityEnclave.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.SecurityEnclave pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.SecurityEnclave";
    }
    
    @Override
    public List<String> parameterNames() {
      return SecurityEnclave.Match.parameterNames;
    }
    ...
    @Override
    public SecurityEnclave.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof SecurityEnclave.Match)) {
          SecurityEnclave.Match other = (SecurityEnclave.Match) obj;
    ...
    @Override
    public SecurityEnclave specification() {
      return SecurityEnclave.instance();
    }
     ...
     * 
     */
    public static SecurityEnclave.Match newEmptyMatch() {
     ...
     * 
     */
    public static SecurityEnclave.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public static SecurityEnclave.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return new Immutable(pElement, pDomainStereotypeInstance);
    }
    
    private static final class Mutable extends SecurityEnclave.Match {
    ...
    private static final class Immutable extends SecurityEnclave.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.SecurityEnclave pattern,
   ...
   * 
   */
  public static class Matcher extends BaseMatcher<SecurityEnclave.Match> {
    /**
     ...
     * 
     */
    public static SecurityEnclave.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static SecurityEnclave.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(SecurityEnclave.Matcher.class);
     ...
     * 
     */
    public Collection<SecurityEnclave.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<SecurityEnclave.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Optional<SecurityEnclave.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance, final Consumer<? super SecurityEnclave.Match> processor) {
     ...
     * 
     */
    public SecurityEnclave.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return SecurityEnclave.Match.newMatch(pElement, pDomainStereotypeInstance);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final SecurityEnclave.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final SecurityEnclave.Match partialMatch) {
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final SecurityEnclave.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final SecurityEnclave.Match partialMatch) {
    ...
    @Override
    protected SecurityEnclave.Match tupleToMatch(final Tuple t) {
      try {
          return SecurityEnclave.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_DOMAINSTEREOTYPEINSTANCE));
    ...
    @Override
    protected SecurityEnclave.Match arrayToMatch(final Object[] match) {
      try {
          return SecurityEnclave.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected SecurityEnclave.Match arrayToMatchMutable(final Object[] match) {
      try {
          return SecurityEnclave.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<SecurityEnclave.Matcher> querySpecification() {
      return SecurityEnclave.instance();
    }
  }
  
  private SecurityEnclave() {
   ...
   * 
   */
  public static SecurityEnclave instance() {
    try{
  ...
  @Override
  protected SecurityEnclave.Matcher instantiate(final ViatraQueryEngine engine) {
    return SecurityEnclave.Matcher.on(engine);
  }
  
  @Override
  public SecurityEnclave.Matcher instantiate() {
    return SecurityEnclave.Matcher.create();
  }
  
  @Override
  public SecurityEnclave.Match newEmptyMatch() {
    return SecurityEnclave.Match.newEmptyMatch();
  }
  
  @Override
  public SecurityEnclave.Match newMatch(final Object... parameters) {
    return SecurityEnclave.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link SecurityEnclave} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link SecurityEnclave#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final SecurityEnclave INSTANCE = new SecurityEnclave();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final SecurityEnclave.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find	stereotypedElement(element, domainStereotypeInstance, "UAF", "SecurityEnclave")
          PVariable var__virtual_0_ = body.getOrCreateVariableByName(".virtual{0}");
          new ConstantValue(body, var__virtual_0_, "UAF");
          PVariable var__virtual_1_ = body.getOrCreateVariableByName(".virtual{1}");
          new ConstantValue(body, var__virtual_1_, "SecurityEnclave");
