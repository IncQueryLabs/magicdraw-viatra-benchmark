...
public final class Property_endBoundaryType extends BaseGeneratedEMFQuerySpecification<Property_endBoundaryType.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Property_endBoundaryType pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.Property_endBoundaryType";
    }
    
    @Override
    public List<String> parameterNames() {
      return Property_endBoundaryType.Match.parameterNames;
    }
    ...
    @Override
    public Property_endBoundaryType.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Property_endBoundaryType.Match)) {
          Property_endBoundaryType.Match other = (Property_endBoundaryType.Match) obj;
    ...
    @Override
    public Property_endBoundaryType specification() {
      return Property_endBoundaryType.instance();
    }
     ...
     * 
     */
    public static Property_endBoundaryType.Match newEmptyMatch() {
     ...
     * 
     */
    public static Property_endBoundaryType.Match newMutableMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public static Property_endBoundaryType.Match newMatch(final Property pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Property_endBoundaryType.Match {
    ...
    private static final class Immutable extends Property_endBoundaryType.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Property_endBoundaryType pattern,
   ...
   * 
   * @see Match
   * @see Property_endBoundaryType
   * 
   */
  public static class Matcher extends BaseMatcher<Property_endBoundaryType.Match> {
    /**
     ...
     * 
     */
    public static Property_endBoundaryType.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Property_endBoundaryType.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Property_endBoundaryType.Matcher.class);
     ...
     * 
     */
    public Collection<Property_endBoundaryType.Match> getAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<Property_endBoundaryType.Match> streamAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<Property_endBoundaryType.Match> getOneArbitraryMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final Element pValue, final Consumer<? super Property_endBoundaryType.Match> processor) {
     ...
     * 
     */
    public Property_endBoundaryType.Match newMatch(final Property pElement, final Element pValue) {
      return Property_endBoundaryType.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfelement(final Property_endBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfelement(final Property_endBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final Property_endBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final Property_endBoundaryType.Match partialMatch) {
    ...
    @Override
    protected Property_endBoundaryType.Match tupleToMatch(final Tuple t) {
      try {
          return Property_endBoundaryType.Match.newMatch((Property) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected Property_endBoundaryType.Match arrayToMatch(final Object[] match) {
      try {
          return Property_endBoundaryType.Match.newMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Property_endBoundaryType.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Property_endBoundaryType.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Property_endBoundaryType.Matcher> querySpecification() {
      return Property_endBoundaryType.instance();
    }
  }
  
  private Property_endBoundaryType() {
   ...
   * 
   */
  public static Property_endBoundaryType instance() {
    try{
  ...
  @Override
  protected Property_endBoundaryType.Matcher instantiate(final ViatraQueryEngine engine) {
    return Property_endBoundaryType.Matcher.on(engine);
  }
  
  @Override
  public Property_endBoundaryType.Matcher instantiate() {
    return Property_endBoundaryType.Matcher.create();
  }
  
  @Override
  public Property_endBoundaryType.Match newEmptyMatch() {
    return Property_endBoundaryType.Match.newEmptyMatch();
  }
  
  @Override
  public Property_endBoundaryType.Match newMatch(final Object... parameters) {
    return Property_endBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Property_endBoundaryType} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Property_endBoundaryType#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Property_endBoundaryType INSTANCE = new Property_endBoundaryType();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Property_endBoundaryType.GeneratedPQuery INSTANCE = new GeneratedPQuery();
