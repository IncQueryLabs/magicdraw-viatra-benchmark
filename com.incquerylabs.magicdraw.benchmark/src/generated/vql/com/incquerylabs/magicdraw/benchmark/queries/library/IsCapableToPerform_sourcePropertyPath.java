...
public final class IsCapableToPerform_sourcePropertyPath extends BaseGeneratedEMFQuerySpecification<IsCapableToPerform_sourcePropertyPath.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.IsCapableToPerform_sourcePropertyPath pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.IsCapableToPerform_sourcePropertyPath";
    }
    
    @Override
    public List<String> parameterNames() {
      return IsCapableToPerform_sourcePropertyPath.Match.parameterNames;
    }
    ...
    @Override
    public IsCapableToPerform_sourcePropertyPath.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof IsCapableToPerform_sourcePropertyPath.Match)) {
          IsCapableToPerform_sourcePropertyPath.Match other = (IsCapableToPerform_sourcePropertyPath.Match) obj;
    ...
    @Override
    public IsCapableToPerform_sourcePropertyPath specification() {
      return IsCapableToPerform_sourcePropertyPath.instance();
    }
     ...
     * 
     */
    public static IsCapableToPerform_sourcePropertyPath.Match newEmptyMatch() {
     ...
     * 
     */
    public static IsCapableToPerform_sourcePropertyPath.Match newMutableMatch(final Abstraction pElement, final Property pValue) {
     ...
     * 
     */
    public static IsCapableToPerform_sourcePropertyPath.Match newMatch(final Abstraction pElement, final Property pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends IsCapableToPerform_sourcePropertyPath.Match {
    ...
    private static final class Immutable extends IsCapableToPerform_sourcePropertyPath.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.IsCapableToPerform_sourcePropertyPath pattern,
   ...
   * 
   * @see Match
   * @see IsCapableToPerform_sourcePropertyPath
   * 
   */
  public static class Matcher extends BaseMatcher<IsCapableToPerform_sourcePropertyPath.Match> {
    /**
     ...
     * 
     */
    public static IsCapableToPerform_sourcePropertyPath.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static IsCapableToPerform_sourcePropertyPath.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(IsCapableToPerform_sourcePropertyPath.Matcher.class);
     ...
     * 
     */
    public Collection<IsCapableToPerform_sourcePropertyPath.Match> getAllMatches(final Abstraction pElement, final Property pValue) {
     ...
     * 
     */
    public Stream<IsCapableToPerform_sourcePropertyPath.Match> streamAllMatches(final Abstraction pElement, final Property pValue) {
     ...
     * 
     */
    public Optional<IsCapableToPerform_sourcePropertyPath.Match> getOneArbitraryMatch(final Abstraction pElement, final Property pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Abstraction pElement, final Property pValue, final Consumer<? super IsCapableToPerform_sourcePropertyPath.Match> processor) {
     ...
     * 
     */
    public IsCapableToPerform_sourcePropertyPath.Match newMatch(final Abstraction pElement, final Property pValue) {
      return IsCapableToPerform_sourcePropertyPath.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Abstraction> streamAllValuesOfelement(final IsCapableToPerform_sourcePropertyPath.Match partialMatch) {
     ...
     * 
     */
    public Set<Abstraction> getAllValuesOfelement(final IsCapableToPerform_sourcePropertyPath.Match partialMatch) {
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfvalue(final IsCapableToPerform_sourcePropertyPath.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfvalue(final IsCapableToPerform_sourcePropertyPath.Match partialMatch) {
    ...
    @Override
    protected IsCapableToPerform_sourcePropertyPath.Match tupleToMatch(final Tuple t) {
      try {
          return IsCapableToPerform_sourcePropertyPath.Match.newMatch((Abstraction) t.get(POSITION_ELEMENT), (Property) t.get(POSITION_VALUE));
    ...
    @Override
    protected IsCapableToPerform_sourcePropertyPath.Match arrayToMatch(final Object[] match) {
      try {
          return IsCapableToPerform_sourcePropertyPath.Match.newMatch((Abstraction) match[POSITION_ELEMENT], (Property) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected IsCapableToPerform_sourcePropertyPath.Match arrayToMatchMutable(final Object[] match) {
      try {
          return IsCapableToPerform_sourcePropertyPath.Match.newMutableMatch((Abstraction) match[POSITION_ELEMENT], (Property) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<IsCapableToPerform_sourcePropertyPath.Matcher> querySpecification() {
      return IsCapableToPerform_sourcePropertyPath.instance();
    }
  }
  
  private IsCapableToPerform_sourcePropertyPath() {
   ...
   * 
   */
  public static IsCapableToPerform_sourcePropertyPath instance() {
    try{
  ...
  @Override
  protected IsCapableToPerform_sourcePropertyPath.Matcher instantiate(final ViatraQueryEngine engine) {
    return IsCapableToPerform_sourcePropertyPath.Matcher.on(engine);
  }
  
  @Override
  public IsCapableToPerform_sourcePropertyPath.Matcher instantiate() {
    return IsCapableToPerform_sourcePropertyPath.Matcher.create();
  }
  
  @Override
  public IsCapableToPerform_sourcePropertyPath.Match newEmptyMatch() {
    return IsCapableToPerform_sourcePropertyPath.Match.newEmptyMatch();
  }
  
  @Override
  public IsCapableToPerform_sourcePropertyPath.Match newMatch(final Object... parameters) {
    return IsCapableToPerform_sourcePropertyPath.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mddependencies.Abstraction) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link IsCapableToPerform_sourcePropertyPath} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link IsCapableToPerform_sourcePropertyPath#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final IsCapableToPerform_sourcePropertyPath INSTANCE = new IsCapableToPerform_sourcePropertyPath();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final IsCapableToPerform_sourcePropertyPath.GeneratedPQuery INSTANCE = new GeneratedPQuery();
