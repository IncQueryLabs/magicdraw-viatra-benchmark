...
public final class ConceptRole_propertySet extends BaseGeneratedEMFQuerySpecification<ConceptRole_propertySet.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ConceptRole_propertySet pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.ConceptRole_propertySet";
    }
    
    @Override
    public List<String> parameterNames() {
      return ConceptRole_propertySet.Match.parameterNames;
    }
    ...
    @Override
    public ConceptRole_propertySet.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ConceptRole_propertySet.Match)) {
          ConceptRole_propertySet.Match other = (ConceptRole_propertySet.Match) obj;
    ...
    @Override
    public ConceptRole_propertySet specification() {
      return ConceptRole_propertySet.instance();
    }
     ...
     * 
     */
    public static ConceptRole_propertySet.Match newEmptyMatch() {
     ...
     * 
     */
    public static ConceptRole_propertySet.Match newMutableMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public static ConceptRole_propertySet.Match newMatch(final Property pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends ConceptRole_propertySet.Match {
    ...
    private static final class Immutable extends ConceptRole_propertySet.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ConceptRole_propertySet pattern,
   ...
   * 
   * @see Match
   * @see ConceptRole_propertySet
   * 
   */
  public static class Matcher extends BaseMatcher<ConceptRole_propertySet.Match> {
    /**
     ...
     * 
     */
    public static ConceptRole_propertySet.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ConceptRole_propertySet.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ConceptRole_propertySet.Matcher.class);
     ...
     * 
     */
    public Collection<ConceptRole_propertySet.Match> getAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<ConceptRole_propertySet.Match> streamAllMatches(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<ConceptRole_propertySet.Match> getOneArbitraryMatch(final Property pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final Element pValue, final Consumer<? super ConceptRole_propertySet.Match> processor) {
     ...
     * 
     */
    public ConceptRole_propertySet.Match newMatch(final Property pElement, final Element pValue) {
      return ConceptRole_propertySet.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfelement(final ConceptRole_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfelement(final ConceptRole_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final ConceptRole_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final ConceptRole_propertySet.Match partialMatch) {
    ...
    @Override
    protected ConceptRole_propertySet.Match tupleToMatch(final Tuple t) {
      try {
          return ConceptRole_propertySet.Match.newMatch((Property) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected ConceptRole_propertySet.Match arrayToMatch(final Object[] match) {
      try {
          return ConceptRole_propertySet.Match.newMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ConceptRole_propertySet.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ConceptRole_propertySet.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ConceptRole_propertySet.Matcher> querySpecification() {
      return ConceptRole_propertySet.instance();
    }
  }
  
  private ConceptRole_propertySet() {
   ...
   * 
   */
  public static ConceptRole_propertySet instance() {
    try{
  ...
  @Override
  protected ConceptRole_propertySet.Matcher instantiate(final ViatraQueryEngine engine) {
    return ConceptRole_propertySet.Matcher.on(engine);
  }
  
  @Override
  public ConceptRole_propertySet.Matcher instantiate() {
    return ConceptRole_propertySet.Matcher.create();
  }
  
  @Override
  public ConceptRole_propertySet.Match newEmptyMatch() {
    return ConceptRole_propertySet.Match.newEmptyMatch();
  }
  
  @Override
  public ConceptRole_propertySet.Match newMatch(final Object... parameters) {
    return ConceptRole_propertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ConceptRole_propertySet} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ConceptRole_propertySet#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ConceptRole_propertySet INSTANCE = new ConceptRole_propertySet();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ConceptRole_propertySet.GeneratedPQuery INSTANCE = new GeneratedPQuery();
