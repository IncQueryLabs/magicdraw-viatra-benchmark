...
public final class EnterprisePhase_propertySet extends BaseGeneratedEMFQuerySpecification<EnterprisePhase_propertySet.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.EnterprisePhase_propertySet pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.EnterprisePhase_propertySet";
    }
    
    @Override
    public List<String> parameterNames() {
      return EnterprisePhase_propertySet.Match.parameterNames;
    }
    ...
    @Override
    public EnterprisePhase_propertySet.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof EnterprisePhase_propertySet.Match)) {
          EnterprisePhase_propertySet.Match other = (EnterprisePhase_propertySet.Match) obj;
    ...
    @Override
    public EnterprisePhase_propertySet specification() {
      return EnterprisePhase_propertySet.instance();
    }
     ...
     * 
     */
    public static EnterprisePhase_propertySet.Match newEmptyMatch() {
     ...
     * 
     */
    public static EnterprisePhase_propertySet.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static EnterprisePhase_propertySet.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends EnterprisePhase_propertySet.Match {
    ...
    private static final class Immutable extends EnterprisePhase_propertySet.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.EnterprisePhase_propertySet pattern,
   ...
   * 
   * @see Match
   * @see EnterprisePhase_propertySet
   * 
   */
  public static class Matcher extends BaseMatcher<EnterprisePhase_propertySet.Match> {
    /**
     ...
     * 
     */
    public static EnterprisePhase_propertySet.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static EnterprisePhase_propertySet.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(EnterprisePhase_propertySet.Matcher.class);
     ...
     * 
     */
    public Collection<EnterprisePhase_propertySet.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<EnterprisePhase_propertySet.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<EnterprisePhase_propertySet.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super EnterprisePhase_propertySet.Match> processor) {
     ...
     * 
     */
    public EnterprisePhase_propertySet.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return EnterprisePhase_propertySet.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final EnterprisePhase_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final EnterprisePhase_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final EnterprisePhase_propertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final EnterprisePhase_propertySet.Match partialMatch) {
    ...
    @Override
    protected EnterprisePhase_propertySet.Match tupleToMatch(final Tuple t) {
      try {
          return EnterprisePhase_propertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected EnterprisePhase_propertySet.Match arrayToMatch(final Object[] match) {
      try {
          return EnterprisePhase_propertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected EnterprisePhase_propertySet.Match arrayToMatchMutable(final Object[] match) {
      try {
          return EnterprisePhase_propertySet.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<EnterprisePhase_propertySet.Matcher> querySpecification() {
      return EnterprisePhase_propertySet.instance();
    }
  }
  
  private EnterprisePhase_propertySet() {
   ...
   * 
   */
  public static EnterprisePhase_propertySet instance() {
    try{
  ...
  @Override
  protected EnterprisePhase_propertySet.Matcher instantiate(final ViatraQueryEngine engine) {
    return EnterprisePhase_propertySet.Matcher.on(engine);
  }
  
  @Override
  public EnterprisePhase_propertySet.Matcher instantiate() {
    return EnterprisePhase_propertySet.Matcher.create();
  }
  
  @Override
  public EnterprisePhase_propertySet.Match newEmptyMatch() {
    return EnterprisePhase_propertySet.Match.newEmptyMatch();
  }
  
  @Override
  public EnterprisePhase_propertySet.Match newMatch(final Object... parameters) {
    return EnterprisePhase_propertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link EnterprisePhase_propertySet} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link EnterprisePhase_propertySet#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final EnterprisePhase_propertySet INSTANCE = new EnterprisePhase_propertySet();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final EnterprisePhase_propertySet.GeneratedPQuery INSTANCE = new GeneratedPQuery();
