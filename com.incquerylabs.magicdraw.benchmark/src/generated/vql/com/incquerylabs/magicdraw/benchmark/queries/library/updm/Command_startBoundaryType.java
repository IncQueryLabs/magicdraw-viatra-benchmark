...
public final class Command_startBoundaryType extends BaseGeneratedEMFQuerySpecification<Command_startBoundaryType.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Command_startBoundaryType pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.Command_startBoundaryType";
    }
    
    @Override
    public List<String> parameterNames() {
      return Command_startBoundaryType.Match.parameterNames;
    }
    ...
    @Override
    public Command_startBoundaryType.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Command_startBoundaryType.Match)) {
          Command_startBoundaryType.Match other = (Command_startBoundaryType.Match) obj;
    ...
    @Override
    public Command_startBoundaryType specification() {
      return Command_startBoundaryType.instance();
    }
     ...
     * 
     */
    public static Command_startBoundaryType.Match newEmptyMatch() {
     ...
     * 
     */
    public static Command_startBoundaryType.Match newMutableMatch(final InformationFlow pElement, final Element pValue) {
     ...
     * 
     */
    public static Command_startBoundaryType.Match newMatch(final InformationFlow pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Command_startBoundaryType.Match {
    ...
    private static final class Immutable extends Command_startBoundaryType.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Command_startBoundaryType pattern,
   ...
   * 
   * @see Match
   * @see Command_startBoundaryType
   * 
   */
  public static class Matcher extends BaseMatcher<Command_startBoundaryType.Match> {
    /**
     ...
     * 
     */
    public static Command_startBoundaryType.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Command_startBoundaryType.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Command_startBoundaryType.Matcher.class);
     ...
     * 
     */
    public Collection<Command_startBoundaryType.Match> getAllMatches(final InformationFlow pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<Command_startBoundaryType.Match> streamAllMatches(final InformationFlow pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<Command_startBoundaryType.Match> getOneArbitraryMatch(final InformationFlow pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final InformationFlow pElement, final Element pValue, final Consumer<? super Command_startBoundaryType.Match> processor) {
     ...
     * 
     */
    public Command_startBoundaryType.Match newMatch(final InformationFlow pElement, final Element pValue) {
      return Command_startBoundaryType.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<InformationFlow> streamAllValuesOfelement(final Command_startBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<InformationFlow> getAllValuesOfelement(final Command_startBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final Command_startBoundaryType.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final Command_startBoundaryType.Match partialMatch) {
    ...
    @Override
    protected Command_startBoundaryType.Match tupleToMatch(final Tuple t) {
      try {
          return Command_startBoundaryType.Match.newMatch((InformationFlow) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected Command_startBoundaryType.Match arrayToMatch(final Object[] match) {
      try {
          return Command_startBoundaryType.Match.newMatch((InformationFlow) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Command_startBoundaryType.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Command_startBoundaryType.Match.newMutableMatch((InformationFlow) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Command_startBoundaryType.Matcher> querySpecification() {
      return Command_startBoundaryType.instance();
    }
  }
  
  private Command_startBoundaryType() {
   ...
   * 
   */
  public static Command_startBoundaryType instance() {
    try{
  ...
  @Override
  protected Command_startBoundaryType.Matcher instantiate(final ViatraQueryEngine engine) {
    return Command_startBoundaryType.Matcher.on(engine);
  }
  
  @Override
  public Command_startBoundaryType.Matcher instantiate() {
    return Command_startBoundaryType.Matcher.create();
  }
  
  @Override
  public Command_startBoundaryType.Match newEmptyMatch() {
    return Command_startBoundaryType.Match.newEmptyMatch();
  }
  
  @Override
  public Command_startBoundaryType.Match newMatch(final Object... parameters) {
    return Command_startBoundaryType.Match.newMatch((com.nomagic.uml2.ext.magicdraw.auxiliaryconstructs.mdinformationflows.InformationFlow) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Command_startBoundaryType} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Command_startBoundaryType#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Command_startBoundaryType INSTANCE = new Command_startBoundaryType();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Command_startBoundaryType.GeneratedPQuery INSTANCE = new GeneratedPQuery();
