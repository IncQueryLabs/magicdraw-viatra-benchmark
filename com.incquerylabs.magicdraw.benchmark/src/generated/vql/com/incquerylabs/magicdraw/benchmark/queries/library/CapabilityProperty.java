...
public final class CapabilityProperty extends BaseGeneratedEMFQuerySpecification<CapabilityProperty.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.CapabilityProperty pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.CapabilityProperty";
    }
    
    @Override
    public List<String> parameterNames() {
      return CapabilityProperty.Match.parameterNames;
    }
    ...
    @Override
    public CapabilityProperty.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof CapabilityProperty.Match)) {
          CapabilityProperty.Match other = (CapabilityProperty.Match) obj;
    ...
    @Override
    public CapabilityProperty specification() {
      return CapabilityProperty.instance();
    }
     ...
     * 
     */
    public static CapabilityProperty.Match newEmptyMatch() {
     ...
     * 
     */
    public static CapabilityProperty.Match newMutableMatch(final Property pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public static CapabilityProperty.Match newMatch(final Property pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return new Immutable(pElement, pDomainStereotypeInstance);
    }
    
    private static final class Mutable extends CapabilityProperty.Match {
    ...
    private static final class Immutable extends CapabilityProperty.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.CapabilityProperty pattern,
   ...
   * 
   * @see Match
   * @see CapabilityProperty
   * 
   */
  public static class Matcher extends BaseMatcher<CapabilityProperty.Match> {
    /**
     ...
     * 
     */
    public static CapabilityProperty.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static CapabilityProperty.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(CapabilityProperty.Matcher.class);
     ...
     * 
     */
    public Collection<CapabilityProperty.Match> getAllMatches(final Property pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Stream<CapabilityProperty.Match> streamAllMatches(final Property pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public Optional<CapabilityProperty.Match> getOneArbitraryMatch(final Property pElement, final InstanceSpecification pDomainStereotypeInstance) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final InstanceSpecification pDomainStereotypeInstance, final Consumer<? super CapabilityProperty.Match> processor) {
     ...
     * 
     */
    public CapabilityProperty.Match newMatch(final Property pElement, final InstanceSpecification pDomainStereotypeInstance) {
      return CapabilityProperty.Match.newMatch(pElement, pDomainStereotypeInstance);
    }
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfelement(final CapabilityProperty.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfelement(final CapabilityProperty.Match partialMatch) {
     ...
     * 
     */
    public Stream<InstanceSpecification> streamAllValuesOfdomainStereotypeInstance(final CapabilityProperty.Match partialMatch) {
     ...
     * 
     */
    public Set<InstanceSpecification> getAllValuesOfdomainStereotypeInstance(final CapabilityProperty.Match partialMatch) {
    ...
    @Override
    protected CapabilityProperty.Match tupleToMatch(final Tuple t) {
      try {
          return CapabilityProperty.Match.newMatch((Property) t.get(POSITION_ELEMENT), (InstanceSpecification) t.get(POSITION_DOMAINSTEREOTYPEINSTANCE));
    ...
    @Override
    protected CapabilityProperty.Match arrayToMatch(final Object[] match) {
      try {
          return CapabilityProperty.Match.newMatch((Property) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected CapabilityProperty.Match arrayToMatchMutable(final Object[] match) {
      try {
          return CapabilityProperty.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (InstanceSpecification) match[POSITION_DOMAINSTEREOTYPEINSTANCE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<CapabilityProperty.Matcher> querySpecification() {
      return CapabilityProperty.instance();
    }
  }
  
  private CapabilityProperty() {
   ...
   * 
   */
  public static CapabilityProperty instance() {
    try{
  ...
  @Override
  protected CapabilityProperty.Matcher instantiate(final ViatraQueryEngine engine) {
    return CapabilityProperty.Matcher.on(engine);
  }
  
  @Override
  public CapabilityProperty.Matcher instantiate() {
    return CapabilityProperty.Matcher.create();
  }
  
  @Override
  public CapabilityProperty.Match newEmptyMatch() {
    return CapabilityProperty.Match.newEmptyMatch();
  }
  
  @Override
  public CapabilityProperty.Match newMatch(final Object... parameters) {
    return CapabilityProperty.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.InstanceSpecification) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link CapabilityProperty} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link CapabilityProperty#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final CapabilityProperty INSTANCE = new CapabilityProperty();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final CapabilityProperty.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find	stereotypedElement(element, domainStereotypeInstance, "UAF", "CapabilityProperty")
          PVariable var__virtual_0_ = body.getOrCreateVariableByName(".virtual{0}");
          new ConstantValue(body, var__virtual_0_, "UAF");
          PVariable var__virtual_1_ = body.getOrCreateVariableByName(".virtual{1}");
          new ConstantValue(body, var__virtual_1_, "CapabilityProperty");
