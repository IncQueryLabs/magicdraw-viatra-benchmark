...
public final class DataElement_URI extends BaseGeneratedEMFQuerySpecification<DataElement_URI.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.DataElement_URI pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.DataElement_URI";
    }
    
    @Override
    public List<String> parameterNames() {
      return DataElement_URI.Match.parameterNames;
    }
    ...
    @Override
    public DataElement_URI.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof DataElement_URI.Match)) {
          DataElement_URI.Match other = (DataElement_URI.Match) obj;
    ...
    @Override
    public DataElement_URI specification() {
      return DataElement_URI.instance();
    }
     ...
     * 
     */
    public static DataElement_URI.Match newEmptyMatch() {
     ...
     * 
     */
    public static DataElement_URI.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public static DataElement_URI.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends DataElement_URI.Match {
    ...
    private static final class Immutable extends DataElement_URI.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.DataElement_URI pattern,
   ...
   * 
   */
  public static class Matcher extends BaseMatcher<DataElement_URI.Match> {
    /**
     ...
     * 
     */
    public static DataElement_URI.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static DataElement_URI.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(DataElement_URI.Matcher.class);
     ...
     * 
     */
    public Collection<DataElement_URI.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Stream<DataElement_URI.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Optional<DataElement_URI.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec, final Consumer<? super DataElement_URI.Match> processor) {
     ...
     * 
     */
    public DataElement_URI.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final LiteralString pValuespec) {
      return DataElement_URI.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final DataElement_URI.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final DataElement_URI.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralString> streamAllValuesOfvaluespec(final DataElement_URI.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralString> getAllValuesOfvaluespec(final DataElement_URI.Match partialMatch) {
    ...
    @Override
    protected DataElement_URI.Match tupleToMatch(final Tuple t) {
      try {
          return DataElement_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (LiteralString) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected DataElement_URI.Match arrayToMatch(final Object[] match) {
      try {
          return DataElement_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected DataElement_URI.Match arrayToMatchMutable(final Object[] match) {
      try {
          return DataElement_URI.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<DataElement_URI.Matcher> querySpecification() {
      return DataElement_URI.instance();
    }
  }
  
  private DataElement_URI() {
   ...
   * 
   */
  public static DataElement_URI instance() {
    try{
  ...
  @Override
  protected DataElement_URI.Matcher instantiate(final ViatraQueryEngine engine) {
    return DataElement_URI.Matcher.on(engine);
  }
  
  @Override
  public DataElement_URI.Matcher instantiate() {
    return DataElement_URI.Matcher.create();
  }
  
  @Override
  public DataElement_URI.Match newEmptyMatch() {
    return DataElement_URI.Match.newEmptyMatch();
  }
  
  @Override
  public DataElement_URI.Match newMatch(final Object... parameters) {
    return DataElement_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralString) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link DataElement_URI} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link DataElement_URI#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final DataElement_URI INSTANCE = new DataElement_URI();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final DataElement_URI.GeneratedPQuery INSTANCE = new GeneratedPQuery();
