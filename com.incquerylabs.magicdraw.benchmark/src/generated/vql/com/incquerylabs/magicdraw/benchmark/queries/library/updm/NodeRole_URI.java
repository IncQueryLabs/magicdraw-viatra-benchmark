...
public final class NodeRole_URI extends BaseGeneratedEMFQuerySpecification<NodeRole_URI.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.NodeRole_URI pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.NodeRole_URI";
    }
    
    @Override
    public List<String> parameterNames() {
      return NodeRole_URI.Match.parameterNames;
    }
    ...
    @Override
    public NodeRole_URI.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof NodeRole_URI.Match)) {
          NodeRole_URI.Match other = (NodeRole_URI.Match) obj;
    ...
    @Override
    public NodeRole_URI specification() {
      return NodeRole_URI.instance();
    }
     ...
     * 
     */
    public static NodeRole_URI.Match newEmptyMatch() {
     ...
     * 
     */
    public static NodeRole_URI.Match newMutableMatch(final Property pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public static NodeRole_URI.Match newMatch(final Property pElement, final LiteralString pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends NodeRole_URI.Match {
    ...
    private static final class Immutable extends NodeRole_URI.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.NodeRole_URI pattern,
   ...
   * 
   */
  public static class Matcher extends BaseMatcher<NodeRole_URI.Match> {
    /**
     ...
     * 
     */
    public static NodeRole_URI.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static NodeRole_URI.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(NodeRole_URI.Matcher.class);
     ...
     * 
     */
    public Collection<NodeRole_URI.Match> getAllMatches(final Property pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Stream<NodeRole_URI.Match> streamAllMatches(final Property pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Optional<NodeRole_URI.Match> getOneArbitraryMatch(final Property pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final LiteralString pValuespec, final Consumer<? super NodeRole_URI.Match> processor) {
     ...
     * 
     */
    public NodeRole_URI.Match newMatch(final Property pElement, final LiteralString pValuespec) {
      return NodeRole_URI.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfelement(final NodeRole_URI.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfelement(final NodeRole_URI.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralString> streamAllValuesOfvaluespec(final NodeRole_URI.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralString> getAllValuesOfvaluespec(final NodeRole_URI.Match partialMatch) {
    ...
    @Override
    protected NodeRole_URI.Match tupleToMatch(final Tuple t) {
      try {
          return NodeRole_URI.Match.newMatch((Property) t.get(POSITION_ELEMENT), (LiteralString) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected NodeRole_URI.Match arrayToMatch(final Object[] match) {
      try {
          return NodeRole_URI.Match.newMatch((Property) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected NodeRole_URI.Match arrayToMatchMutable(final Object[] match) {
      try {
          return NodeRole_URI.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<NodeRole_URI.Matcher> querySpecification() {
      return NodeRole_URI.instance();
    }
  }
  
  private NodeRole_URI() {
   ...
   * 
   */
  public static NodeRole_URI instance() {
    try{
  ...
  @Override
  protected NodeRole_URI.Matcher instantiate(final ViatraQueryEngine engine) {
    return NodeRole_URI.Matcher.on(engine);
  }
  
  @Override
  public NodeRole_URI.Matcher instantiate() {
    return NodeRole_URI.Matcher.create();
  }
  
  @Override
  public NodeRole_URI.Match newEmptyMatch() {
    return NodeRole_URI.Match.newEmptyMatch();
  }
  
  @Override
  public NodeRole_URI.Match newMatch(final Object... parameters) {
    return NodeRole_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralString) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link NodeRole_URI} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link NodeRole_URI#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final NodeRole_URI INSTANCE = new NodeRole_URI();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final NodeRole_URI.GeneratedPQuery INSTANCE = new GeneratedPQuery();
