...
public final class HighLevelOperationalConcept_conformsTo extends BaseGeneratedEMFQuerySpecification<HighLevelOperationalConcept_conformsTo.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.HighLevelOperationalConcept_conformsTo pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.HighLevelOperationalConcept_conformsTo";
    }
    
    @Override
    public List<String> parameterNames() {
      return HighLevelOperationalConcept_conformsTo.Match.parameterNames;
    }
    ...
    @Override
    public HighLevelOperationalConcept_conformsTo.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof HighLevelOperationalConcept_conformsTo.Match)) {
          HighLevelOperationalConcept_conformsTo.Match other = (HighLevelOperationalConcept_conformsTo.Match) obj;
    ...
    @Override
    public HighLevelOperationalConcept_conformsTo specification() {
      return HighLevelOperationalConcept_conformsTo.instance();
    }
     ...
     * 
     */
    public static HighLevelOperationalConcept_conformsTo.Match newEmptyMatch() {
     ...
     * 
     */
    public static HighLevelOperationalConcept_conformsTo.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static HighLevelOperationalConcept_conformsTo.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends HighLevelOperationalConcept_conformsTo.Match {
    ...
    private static final class Immutable extends HighLevelOperationalConcept_conformsTo.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.HighLevelOperationalConcept_conformsTo pattern,
   ...
   * 
   * @see Match
   * @see HighLevelOperationalConcept_conformsTo
   * 
   */
  public static class Matcher extends BaseMatcher<HighLevelOperationalConcept_conformsTo.Match> {
    /**
     ...
     * 
     */
    public static HighLevelOperationalConcept_conformsTo.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static HighLevelOperationalConcept_conformsTo.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(HighLevelOperationalConcept_conformsTo.Matcher.class);
     ...
     * 
     */
    public Collection<HighLevelOperationalConcept_conformsTo.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<HighLevelOperationalConcept_conformsTo.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<HighLevelOperationalConcept_conformsTo.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super HighLevelOperationalConcept_conformsTo.Match> processor) {
     ...
     * 
     */
    public HighLevelOperationalConcept_conformsTo.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return HighLevelOperationalConcept_conformsTo.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final HighLevelOperationalConcept_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final HighLevelOperationalConcept_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final HighLevelOperationalConcept_conformsTo.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final HighLevelOperationalConcept_conformsTo.Match partialMatch) {
    ...
    @Override
    protected HighLevelOperationalConcept_conformsTo.Match tupleToMatch(final Tuple t) {
      try {
          return HighLevelOperationalConcept_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected HighLevelOperationalConcept_conformsTo.Match arrayToMatch(final Object[] match) {
      try {
          return HighLevelOperationalConcept_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected HighLevelOperationalConcept_conformsTo.Match arrayToMatchMutable(final Object[] match) {
      try {
          return HighLevelOperationalConcept_conformsTo.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<HighLevelOperationalConcept_conformsTo.Matcher> querySpecification() {
      return HighLevelOperationalConcept_conformsTo.instance();
    }
  }
  
  private HighLevelOperationalConcept_conformsTo() {
   ...
   * 
   */
  public static HighLevelOperationalConcept_conformsTo instance() {
    try{
  ...
  @Override
  protected HighLevelOperationalConcept_conformsTo.Matcher instantiate(final ViatraQueryEngine engine) {
    return HighLevelOperationalConcept_conformsTo.Matcher.on(engine);
  }
  
  @Override
  public HighLevelOperationalConcept_conformsTo.Matcher instantiate() {
    return HighLevelOperationalConcept_conformsTo.Matcher.create();
  }
  
  @Override
  public HighLevelOperationalConcept_conformsTo.Match newEmptyMatch() {
    return HighLevelOperationalConcept_conformsTo.Match.newEmptyMatch();
  }
  
  @Override
  public HighLevelOperationalConcept_conformsTo.Match newMatch(final Object... parameters) {
    return HighLevelOperationalConcept_conformsTo.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link HighLevelOperationalConcept_conformsTo} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link HighLevelOperationalConcept_conformsTo#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final HighLevelOperationalConcept_conformsTo INSTANCE = new HighLevelOperationalConcept_conformsTo();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final HighLevelOperationalConcept_conformsTo.GeneratedPQuery INSTANCE = new GeneratedPQuery();
