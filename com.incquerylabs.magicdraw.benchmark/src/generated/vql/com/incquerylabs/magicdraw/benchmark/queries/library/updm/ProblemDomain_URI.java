...
public final class ProblemDomain_URI extends BaseGeneratedEMFQuerySpecification<ProblemDomain_URI.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ProblemDomain_URI pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.ProblemDomain_URI";
    }
    
    @Override
    public List<String> parameterNames() {
      return ProblemDomain_URI.Match.parameterNames;
    }
    ...
    @Override
    public ProblemDomain_URI.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof ProblemDomain_URI.Match)) {
          ProblemDomain_URI.Match other = (ProblemDomain_URI.Match) obj;
    ...
    @Override
    public ProblemDomain_URI specification() {
      return ProblemDomain_URI.instance();
    }
     ...
     * 
     */
    public static ProblemDomain_URI.Match newEmptyMatch() {
     ...
     * 
     */
    public static ProblemDomain_URI.Match newMutableMatch(final Property pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public static ProblemDomain_URI.Match newMatch(final Property pElement, final LiteralString pValuespec) {
      return new Immutable(pElement, pValuespec);
    }
    
    private static final class Mutable extends ProblemDomain_URI.Match {
    ...
    private static final class Immutable extends ProblemDomain_URI.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.ProblemDomain_URI pattern,
   ...
   * 
   * @see Match
   * @see ProblemDomain_URI
   * 
   */
  public static class Matcher extends BaseMatcher<ProblemDomain_URI.Match> {
    /**
     ...
     * 
     */
    public static ProblemDomain_URI.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static ProblemDomain_URI.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(ProblemDomain_URI.Matcher.class);
     ...
     * 
     */
    public Collection<ProblemDomain_URI.Match> getAllMatches(final Property pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Stream<ProblemDomain_URI.Match> streamAllMatches(final Property pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public Optional<ProblemDomain_URI.Match> getOneArbitraryMatch(final Property pElement, final LiteralString pValuespec) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final Property pElement, final LiteralString pValuespec, final Consumer<? super ProblemDomain_URI.Match> processor) {
     ...
     * 
     */
    public ProblemDomain_URI.Match newMatch(final Property pElement, final LiteralString pValuespec) {
      return ProblemDomain_URI.Match.newMatch(pElement, pValuespec);
    }
     ...
     * 
     */
    public Stream<Property> streamAllValuesOfelement(final ProblemDomain_URI.Match partialMatch) {
     ...
     * 
     */
    public Set<Property> getAllValuesOfelement(final ProblemDomain_URI.Match partialMatch) {
     ...
     * 
     */
    public Stream<LiteralString> streamAllValuesOfvaluespec(final ProblemDomain_URI.Match partialMatch) {
     ...
     * 
     */
    public Set<LiteralString> getAllValuesOfvaluespec(final ProblemDomain_URI.Match partialMatch) {
    ...
    @Override
    protected ProblemDomain_URI.Match tupleToMatch(final Tuple t) {
      try {
          return ProblemDomain_URI.Match.newMatch((Property) t.get(POSITION_ELEMENT), (LiteralString) t.get(POSITION_VALUESPEC));
    ...
    @Override
    protected ProblemDomain_URI.Match arrayToMatch(final Object[] match) {
      try {
          return ProblemDomain_URI.Match.newMatch((Property) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected ProblemDomain_URI.Match arrayToMatchMutable(final Object[] match) {
      try {
          return ProblemDomain_URI.Match.newMutableMatch((Property) match[POSITION_ELEMENT], (LiteralString) match[POSITION_VALUESPEC]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<ProblemDomain_URI.Matcher> querySpecification() {
      return ProblemDomain_URI.instance();
    }
  }
  
  private ProblemDomain_URI() {
   ...
   * 
   */
  public static ProblemDomain_URI instance() {
    try{
  ...
  @Override
  protected ProblemDomain_URI.Matcher instantiate(final ViatraQueryEngine engine) {
    return ProblemDomain_URI.Matcher.on(engine);
  }
  
  @Override
  public ProblemDomain_URI.Matcher instantiate() {
    return ProblemDomain_URI.Matcher.create();
  }
  
  @Override
  public ProblemDomain_URI.Match newEmptyMatch() {
    return ProblemDomain_URI.Match.newEmptyMatch();
  }
  
  @Override
  public ProblemDomain_URI.Match newMatch(final Object... parameters) {
    return ProblemDomain_URI.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Property) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.LiteralString) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link ProblemDomain_URI} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link ProblemDomain_URI#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final ProblemDomain_URI INSTANCE = new ProblemDomain_URI();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final ProblemDomain_URI.GeneratedPQuery INSTANCE = new GeneratedPQuery();
