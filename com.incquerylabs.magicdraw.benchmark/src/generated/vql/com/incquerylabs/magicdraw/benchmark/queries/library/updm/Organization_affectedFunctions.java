...
public final class Organization_affectedFunctions extends BaseGeneratedEMFQuerySpecification<Organization_affectedFunctions.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Organization_affectedFunctions pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.Organization_affectedFunctions";
    }
    
    @Override
    public List<String> parameterNames() {
      return Organization_affectedFunctions.Match.parameterNames;
    }
    ...
    @Override
    public Organization_affectedFunctions.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof Organization_affectedFunctions.Match)) {
          Organization_affectedFunctions.Match other = (Organization_affectedFunctions.Match) obj;
    ...
    @Override
    public Organization_affectedFunctions specification() {
      return Organization_affectedFunctions.instance();
    }
     ...
     * 
     */
    public static Organization_affectedFunctions.Match newEmptyMatch() {
     ...
     * 
     */
    public static Organization_affectedFunctions.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static Organization_affectedFunctions.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends Organization_affectedFunctions.Match {
    ...
    private static final class Immutable extends Organization_affectedFunctions.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.Organization_affectedFunctions pattern,
   ...
   * 
   * @see Match
   * @see Organization_affectedFunctions
   * 
   */
  public static class Matcher extends BaseMatcher<Organization_affectedFunctions.Match> {
    /**
     ...
     * 
     */
    public static Organization_affectedFunctions.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static Organization_affectedFunctions.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(Organization_affectedFunctions.Matcher.class);
     ...
     * 
     */
    public Collection<Organization_affectedFunctions.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<Organization_affectedFunctions.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<Organization_affectedFunctions.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super Organization_affectedFunctions.Match> processor) {
     ...
     * 
     */
    public Organization_affectedFunctions.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return Organization_affectedFunctions.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final Organization_affectedFunctions.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final Organization_affectedFunctions.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final Organization_affectedFunctions.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final Organization_affectedFunctions.Match partialMatch) {
    ...
    @Override
    protected Organization_affectedFunctions.Match tupleToMatch(final Tuple t) {
      try {
          return Organization_affectedFunctions.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected Organization_affectedFunctions.Match arrayToMatch(final Object[] match) {
      try {
          return Organization_affectedFunctions.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected Organization_affectedFunctions.Match arrayToMatchMutable(final Object[] match) {
      try {
          return Organization_affectedFunctions.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<Organization_affectedFunctions.Matcher> querySpecification() {
      return Organization_affectedFunctions.instance();
    }
  }
  
  private Organization_affectedFunctions() {
   ...
   * 
   */
  public static Organization_affectedFunctions instance() {
    try{
  ...
  @Override
  protected Organization_affectedFunctions.Matcher instantiate(final ViatraQueryEngine engine) {
    return Organization_affectedFunctions.Matcher.on(engine);
  }
  
  @Override
  public Organization_affectedFunctions.Matcher instantiate() {
    return Organization_affectedFunctions.Matcher.create();
  }
  
  @Override
  public Organization_affectedFunctions.Match newEmptyMatch() {
    return Organization_affectedFunctions.Match.newEmptyMatch();
  }
  
  @Override
  public Organization_affectedFunctions.Match newMatch(final Object... parameters) {
    return Organization_affectedFunctions.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link Organization_affectedFunctions} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link Organization_affectedFunctions#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final Organization_affectedFunctions INSTANCE = new Organization_affectedFunctions();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final Organization_affectedFunctions.GeneratedPQuery INSTANCE = new GeneratedPQuery();
