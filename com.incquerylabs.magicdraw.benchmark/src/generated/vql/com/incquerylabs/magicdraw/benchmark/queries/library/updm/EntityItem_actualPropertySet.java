...
public final class EntityItem_actualPropertySet extends BaseGeneratedEMFQuerySpecification<EntityItem_actualPropertySet.Matcher> {
  /**
   * Pattern-specific match representation of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.EntityItem_actualPropertySet pattern,
  ...
  public static abstract class Match extends BasePatternMatch {
    ...
    public String patternName() {
      return "com.incquerylabs.magicdraw.benchmark.queries.library.updm.EntityItem_actualPropertySet";
    }
    
    @Override
    public List<String> parameterNames() {
      return EntityItem_actualPropertySet.Match.parameterNames;
    }
    ...
    @Override
    public EntityItem_actualPropertySet.Match toImmutable() {
    ...
    public boolean equals(final Object obj) {
      ...
      if ((obj instanceof EntityItem_actualPropertySet.Match)) {
          EntityItem_actualPropertySet.Match other = (EntityItem_actualPropertySet.Match) obj;
    ...
    @Override
    public EntityItem_actualPropertySet specification() {
      return EntityItem_actualPropertySet.instance();
    }
     ...
     * 
     */
    public static EntityItem_actualPropertySet.Match newEmptyMatch() {
     ...
     * 
     */
    public static EntityItem_actualPropertySet.Match newMutableMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public static EntityItem_actualPropertySet.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return new Immutable(pElement, pValue);
    }
    
    private static final class Mutable extends EntityItem_actualPropertySet.Match {
    ...
    private static final class Immutable extends EntityItem_actualPropertySet.Match {
  ...
  /**
   * Generated pattern matcher API of the com.incquerylabs.magicdraw.benchmark.queries.library.updm.EntityItem_actualPropertySet pattern,
   ...
   * 
   * @see Match
   * @see EntityItem_actualPropertySet
   * 
   */
  public static class Matcher extends BaseMatcher<EntityItem_actualPropertySet.Match> {
    /**
     ...
     * 
     */
    public static EntityItem_actualPropertySet.Matcher on(final ViatraQueryEngine engine) {
     ...
     * 
     */
    public static EntityItem_actualPropertySet.Matcher create() {
      return new Matcher();
    }
    ...
    private static final Logger LOGGER = ViatraQueryLoggingUtil.getLogger(EntityItem_actualPropertySet.Matcher.class);
     ...
     * 
     */
    public Collection<EntityItem_actualPropertySet.Match> getAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Stream<EntityItem_actualPropertySet.Match> streamAllMatches(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public Optional<EntityItem_actualPropertySet.Match> getOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
     ...
     * 
     */
    public boolean forOneArbitraryMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue, final Consumer<? super EntityItem_actualPropertySet.Match> processor) {
     ...
     * 
     */
    public EntityItem_actualPropertySet.Match newMatch(final com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class pElement, final Element pValue) {
      return EntityItem_actualPropertySet.Match.newMatch(pElement, pValue);
    }
     ...
     * 
     */
    public Stream<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> streamAllValuesOfelement(final EntityItem_actualPropertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class> getAllValuesOfelement(final EntityItem_actualPropertySet.Match partialMatch) {
     ...
     * 
     */
    public Stream<Element> streamAllValuesOfvalue(final EntityItem_actualPropertySet.Match partialMatch) {
     ...
     * 
     */
    public Set<Element> getAllValuesOfvalue(final EntityItem_actualPropertySet.Match partialMatch) {
    ...
    @Override
    protected EntityItem_actualPropertySet.Match tupleToMatch(final Tuple t) {
      try {
          return EntityItem_actualPropertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) t.get(POSITION_ELEMENT), (Element) t.get(POSITION_VALUE));
    ...
    @Override
    protected EntityItem_actualPropertySet.Match arrayToMatch(final Object[] match) {
      try {
          return EntityItem_actualPropertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
    ...
    @Override
    protected EntityItem_actualPropertySet.Match arrayToMatchMutable(final Object[] match) {
      try {
          return EntityItem_actualPropertySet.Match.newMutableMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) match[POSITION_ELEMENT], (Element) match[POSITION_VALUE]);
      } catch(ClassCastException e) {
          LOGGER.error("Element(s) in array not properly typed!",e);
          return null;
      }
     ...
     * 
     */
    public static IQuerySpecification<EntityItem_actualPropertySet.Matcher> querySpecification() {
      return EntityItem_actualPropertySet.instance();
    }
  }
  
  private EntityItem_actualPropertySet() {
   ...
   * 
   */
  public static EntityItem_actualPropertySet instance() {
    try{
  ...
  @Override
  protected EntityItem_actualPropertySet.Matcher instantiate(final ViatraQueryEngine engine) {
    return EntityItem_actualPropertySet.Matcher.on(engine);
  }
  
  @Override
  public EntityItem_actualPropertySet.Matcher instantiate() {
    return EntityItem_actualPropertySet.Matcher.create();
  }
  
  @Override
  public EntityItem_actualPropertySet.Match newEmptyMatch() {
    return EntityItem_actualPropertySet.Match.newEmptyMatch();
  }
  
  @Override
  public EntityItem_actualPropertySet.Match newMatch(final Object... parameters) {
    return EntityItem_actualPropertySet.Match.newMatch((com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Class) parameters[0], (com.nomagic.uml2.ext.magicdraw.classes.mdkernel.Element) parameters[1]);
  }
  
  /**
   * Inner class allowing the singleton instance of {@link EntityItem_actualPropertySet} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link EntityItem_actualPropertySet#instance()}.
   * 
   * <p> This workaround is required e.g. to support recursion.
   * 
   */
  private static class LazyHolder {
    private static final EntityItem_actualPropertySet INSTANCE = new EntityItem_actualPropertySet();
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    private static final EntityItem_actualPropertySet.GeneratedPQuery INSTANCE = new GeneratedPQuery();
    ...
    public Set<PBody> doGetContainedBodies() {
      ...
      Set<PBody> bodies = new LinkedHashSet<>();
      {
          ...
          // 	find EntityItem(element, domainStereotypeInstance)
          new PositivePatternCall(body, Tuples.flatTupleOf(var_element, var_domainStereotypeInstance), EntityItem.instance().getInternalQueryRepresentation());
          // 	find com.incquerylabs.magicdraw.benchmark.queries.library.slotValue(domainStereotypeInstance, "actualPropertySet", valuespec)
